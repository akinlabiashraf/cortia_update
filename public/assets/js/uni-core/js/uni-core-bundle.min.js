/*! UniCore 3.19.1 | https://www.unistudio.co | (c) 2023 - 2024 UniStudio | MIT License */ (function(te, $e) {
  typeof exports == "object" && typeof module < "u" ? module.exports = $e(require("animejs")) : typeof define == "function" && define.amd ? define("uikit", [ "animejs" ], $e) : (te = typeof globalThis < "u" ? globalThis : te || self, 
  te.UniCore = $e(te.anime));
})(this, function(te) {
  "use strict";
  const {hasOwnProperty: $e, toString: tr} = Object.prototype;
  function gt(t, e) {
    return $e.call(t, e);
  }
  const er = /\B([A-Z])/g, Mt = rt(t => t.replace(er, "-$1").toLowerCase()), ir = /-(\w)/g, ye = rt(t => (t.charAt(0).toLowerCase() + t.slice(1)).replace(ir, (e, i) => i.toUpperCase())), St = rt(t => t.charAt(0).toUpperCase() + t.slice(1));
  function dt(t, e) {
    var i;
  ...
  const {isArray: Q, from: It} = Array, {assign: mt} = Object;
  function it(t) {
  ...
  function xt(t) {
    return tr.call(t) === "[object Object]";
  }
  function ie(t) {
  ...
  function T(t) {
    return ti(t) ? [ t ] : Array.from(t || []).filter(ti);
  }
  function ne(t) {
    if (ie(t)) return t;
    t = F(t);
  ...
  function zt(t, e) {
    return t.reduce((i, s) => i + S(it(e) ? e(s) : s[e]), 0);
  }
  function Hs(t, e) {
    const i = new Set;
  ...
  function ot(t, e, i = 0, s = !1) {
    e = T(e);
    const {length: n} = e;
    return n ? (t = vt(t) ? $t(t) : t === "next" ? i + 1 : t === "previous" ? i - 1 : t === "last" ? n - 1 : e.indexOf(F(t)), 
    s ? tt(t, 0, n - 1) : (t %= n, t < 0 ? t + n : t)) : -1;
  }
  function rt(t) {
  ...
  function p(t, e, i) {
    ...
    if (X(i)) return (s = F(t)) == null ? void 0 : s.getAttribute(e);
    for (const n of T(t)) it(i) && (i = i.call(n, p(n, e))), i === null ? Ce(n, e) : n.setAttribute(e, i);
  }
  function Tt(t, e) {
  ...
  function G(t, e) {
    for (const i of [ e, `data-${e}` ]) if (Tt(t, i)) return p(t, i);
  }
  function $(t, ...e) {
    for (const i of T(t)) {
  ...
  function Ri(t, e) {
    e = new RegExp(e);
    for (const i of T(t)) i.classList.remove(...It(i.classList).filter(s => s.match(e)));
  }
  function ni(t, e, i) {
    i = Ft(i), e = Ft(e).filter(s => !m(i, s)), O(t, e), $(t, i);
  }
  function y(t, e) {
    return [e] = Ft(e), T(t).some(i => i.classList.contains(e));
  }
  function j(t, e, i) {
    const s = Ft(e);
    X(i) || (i = !!i);
  ...
  function qi(t) {
    return T(t).some(e => nr[e.tagName.toLowerCase()]);
  }
  function q(t) {
  ...
  function Ws(t, e) {
    return N(e) ? !!ri(t, e) : F(e).contains(F(t));
  }
  function _e(t, e) {
    const i = [];
    for (;t = P(t); ) (!e || E(t, e)) && i.push(t);
    return i;
  }
  function B(t, e) {
    t = F(t);
  ...
  function Et(t, e) {
    return e ? T(t).indexOf(F(e)) : B(P(t)).indexOf(t);
  }
  function oe(t) {
  ...
  function Oe(t, e) {
    return T(qs(t, F(e), "querySelectorAll"));
  }
  const or = /(^|[^\\],)\s*[!>+~-]/, js = rt(t => t.match(or));
  function Rs(t, e = document) {
    return N(t) && js(t) || ke(e) ? e : e.ownerDocument;
  }
  const rr = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g, ar = rt(t => t.replace(rr, "$1 *"));
  ...
  const lr = /.*?[^\\](?![^(]*\))(?:,|$)/g, hr = rt(t => t.match(lr).map(e => e.replace(/,$/, "").trim()));
  function cr(t) {
    const e = [];
    for (;t.parentNode; ) {
      const i = p(t, "id");
      if (i) {
        ...
        let {tagName: s} = t;
        s !== "HTML" && (s += `:nth-child(${Et(t) + 1})`), e.unshift(s), t = t.parentNode;
      }
    }
    return e.join(" > ");
  }
  ...
  function b(...t) {
    ...
    n.length > 1 && (n = dr(n)), o != null && o.self && (n = fr(n)), s && (n = ur(s, n));
  ...
  function H(...t) {
    const [e, i, s, n, o = !1, r] = Gi(t), a = b(e, i, s, l => {
      const h = !r || r(l);
      h && (a(), n(l, h));
    }, o);
    return a;
  ...
  function Gi(t) {
    return t[0] = Ji(t[0]), N(t[1]) && (t[1] = t[1].split(" ")), it(t[2]) && t.splice(2, 0, !1), 
    t;
  }
  function ur(t, e) {
    return i => {
  ...
  function Ji(t) {
    return Q(t) ? t.map(pr).filter(Boolean) : N(t) ? Oe(t) : Us(t) ? [ t ] : T(t);
  }
  function yt(t) {
  ...
  function c(t, e, i, s) {
    ...
    for (const o of n) if (N(e)) {
      if (e = ai(e), X(i)) return getComputedStyle(o).getPropertyValue(e);
      o.style.setProperty(e, vt(i) && !gr[e] ? `${i}px` : i || Ie(i) ? i : "", s);
    } else if (Q(e)) {
      const r = {};
  ...
  const Ki = "uc-transition", Zi = "transitionend", Qi = "transitioncanceled";
  function vr(t, e, i = 400, s = "linear") {
    return i = Math.round(i), Promise.all(T(t).map(n => new Promise((o, r) => {
      ...
      H(n, [ Zi, Qi ], ({type: l}) => {
        ...
        transitionProperty: Object.keys(e).map(ai).join(","),
  ...
  }, De = "uc-animation-", Vs = "animationend", li = "animationcanceled";
  function Ys(t, e, i = 200, s, n) {
    return Promise.all(T(t).map(o => new Promise((r, a) => {
      g(o, li);
      const l = setTimeout(() => g(o, Vs), i);
      H(o, [ Vs, li ], ({type: h}) => {
        clearTimeout(l), h === li ? a() : r(o), c(o, "animationDuration", ""), Ri(o, `${De}\\S*`);
      }, {
        self: !0
      }), c(o, "animationDuration", `${i}ms`), $(o, e, De + (n ? "leave" : "enter")), 
      dt(e, De) && (s && $(o, `uc-transform-origin-${s}`), n && $(o, `${De}reverse`));
    })));
  }
  const wr = new RegExp(`${De}(enter|leave)`), At = {
    in: Ys,
    out(t, e, i, s) {
      return Ys(t, e, i, s, !0);
    },
    inProgress(t) {
      return wr.test(p(t, "class"));
    },
    cancel(t) {
      g(t, li);
    }
  ...
  function Lt(t, e) {
    return X(e) ? k(t).innerHTML : L(ts(t), e);
  }
  const $r = ui("prepend"), L = ui("append"), hi = ui("before"), ci = ui("after");
  function ui(t) {
    return function(e, i) {
      var s;
      const n = T(N(i) ? Wt(i) : i);
      return (s = k(e)) == null || s[t](...n), Xs(n);
    };
  }
  function at(t) {
  ...
  function di(t, e) {
    for (e = F(hi(t, e)); e.firstElementChild; ) e = e.firstElementChild;
    return L(e, t), e;
  }
  function es(t, e) {
    return T(T(t).map(i => i.hasChildNodes() ? di(It(i.childNodes), e) : L(i, e)));
  }
  function re(t) {
    T(t).map(P).filter((e, i, s) => s.indexOf(e) === i).forEach(e => e.replaceWith(...e.childNodes));
  }
  const yr = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
  function Wt(t) {
    const e = yr.exec(t);
  ...
  function kt(t, e) {
    if (Se(t)) for (e(t), t = t.firstElementChild; t; ) {
      const i = t.nextElementSibling;
      kt(t, e), t = i;
    }
  }
  function k(t, e) {
    return Gs(t) ? F(Wt(t)) : Yi(t, e);
  }
  function z(t, e) {
    return Gs(t) ? T(Wt(t)) : Oe(t, e);
  }
  function Gs(t) {
  ...
  function w(t) {
    const e = Se(t) ? F(t).getBoundingClientRect() : {
      height: st(t),
      width: fi(t),
      top: 0,
      left: 0
  ...
  function Rt(t) {
    ...
    for (;t = t.offsetParent; ) if (e[0] += t.offsetTop + S(c(t, "borderTopWidth")), 
    e[1] += t.offsetLeft + S(c(t, "borderLeftWidth")), c(t, "position") === "fixed") {
      const i = ne(t);
      return e[0] += i.scrollY, e[1] += i.scrollX, e;
    }
    return e;
  }
  const st = Js("height"), fi = Js("width");
  function Js(t) {
    const e = St(t);
    return (i, s) => {
      if (X(s)) {
        ...
        return i = F(i), s = c(i, t), s = s === "auto" ? i[`offset${e}`] : S(s) || 0, s - Me(i, t);
      } else return c(i, t, !s && s !== 0 ? "" : +s + Me(i, t) + "px");
    };
  }
  ...
  function U(t, e = "width", i = window, s = !1) {
    return N(t) ? zt(Sr(t), n => {
      const o = Cr(n);
      return o ? Tr(o === "vh" ? Er() : o === "vw" ? fi(ne(i)) : s ? i[`offset${St(e)}`] : w(i)[e], n) : n;
    }) : S(t);
  }
  const kr = /-?\d+(?:\.\d+)?(?:v[wh]|%|px)?/g, Sr = rt(t => t.toString().replace(/\s/g, "").match(kr) || []), Ir = /(?:v[hw]|%)$/, Cr = rt(t => (t.match(Ir) || [])[0]);
  function Tr(t, e) {
    return t * S(e) / 100;
  }
  let Be, ae;
  function Er() {
    return Be || (ae || (ae = k("<div>"), c(ae, {
      height: "100vh",
      position: "fixed"
    }), b(window, "resize", () => Be = null)), L(document.body, ae), Be = ae.clientHeight, 
    at(ae), Be);
  }
  const le = typeof window < "u", V = le && document.dir === "rtl", he = le && "ontouchstart" in window, ce = le && window.PointerEvent, ft = ce ? "pointerdown" : he ? "touchstart" : "mousedown", gi = ce ? "pointermove" : he ? "touchmove" : "mousemove", Ot = ce ? "pointerup" : he ? "touchend" : "mouseup", ue = ce ? "pointerenter" : he ? "" : "mouseenter", Ne = ce ? "pointerleave" : he ? "" : "mouseleave", mi = ce ? "pointercancel" : "touchcancel", K = {
    reads: [],
    writes: [],
    read(t) {
  ...
  const Pr = 4;
  function ns(t) {
    K.scheduled || (K.scheduled = !0, t && t < Pr ? Promise.resolve().then(() => ss(t)) : requestAnimationFrame(() => ss(1)));
  }
  function Ks(t) {
    let e;
    for (;e = t.shift(); ) try {
  ...
  class Qs {
    ...
    movesTo(e) {
      ...
      const i = w(e), {left: s, right: n, top: o, bottom: r} = i, [a] = this.positions, l = Bt(this.positions), h = [ a, l ];
      return si(l, i) ? !1 : [ [ {
        x: s,
        y: o
      }, {
  ...
  function _r([{x: t, y: e}, {x: i, y: s}], [{x: n, y: o}, {x: r, y: a}]) {
  ...
  const Ar = le && window.ResizeObserver;
  function de(t, e, i = {
    box: "border-box"
  }) {
    if (Ar) return sn(ResizeObserver, t, e, i);
    const s = [ b(window, "load resize", e), b(document, "loadedmetadata load", e, !0) ];
    return {
  ...
  function os(t) {
    return {
      disconnect: b([ window, window.visualViewport ], "resize", t)
    };
  }
  function en(t, e, i) {
  ...
  function un(t, {offset: e = 0} = {}) {
    ...
    return i.reduce((r, a, l) => {
      ...
      return e > 0 && d < x + e ? M += e : e = 0, M > v ? (e -= M - v, M = v) : M < 0 && (e -= M, 
      M = 0), () => s(a, M - h, t, v).then(r);
    }, () => Promise.resolve())();
    function s(r, a, l, h) {
      return new Promise(u => {
        ...
        (function Qe() {
          ...
          let pt = 0;
          if (i[0] === r && d + a < h) {
            pt = I(l).top + (x ? 0 : r.scrollTop) - C;
            const xe = ls(l);
            pt -= xe ? I(xe).height : 0;
          }
          r.scrollTop = Math[a + pt > 0 ? "max" : "min"](r.scrollTop, d + (a + pt) * Mi), 
          Mi === 1 && (M === pt || !wt--) ? u() : (M = pt, requestAnimationFrame(Qe));
        })();
      });
    }
    function n(r) {
  ...
  function bi(t, e = 0, i = 0) {
    if (!q(t)) return 0;
    const s = Dt(t, !0), {scrollHeight: n, scrollTop: o} = s, {height: r} = lt(s), a = n - r, l = Rt(t)[0] - Rt(s)[0], h = Math.max(0, l - r + e), u = Math.min(a, l + t.offsetHeight - i);
  ...
  function ls(t) {
    ...
    return t.ownerDocument.elementsFromPoint(e + i / 2, s).find(n => !n.contains(t) && !y(n, "uc-togglable-leave") && (hs(n, "fixed") && dn(_e(t).reverse().find(o => !o.contains(n) && !hs(o, "static"))) < dn(n) || hs(n, "sticky") && P(n).contains(t)));
  }
  function dn(t) {
    return S(c(t, "zIndex"));
  }
  ...
  function pn(t, e, i) {
    ...
    for (const [l, [h, , u, d]] of Object.entries(ht)) {
      ...
      if (xi(s, f, l)) continue;
      let v = 0;
      if (r[l] === "flip") {
        const x = i.attach.target[l];
        if (x === d && s[d] <= f[d] || x === u && s[u] >= f[u]) continue;
        v = zr(t, e, i, l)[u] - s[u];
        const C = Nr(t, e[l], o, l);
        if (!xi(us(s, v, l), C, l)) {
          if (xi(s, C, l)) continue;
          if (i.recursion) return !1;
          const M = Fr(t, e, i);
          if (M && xi(M, C, 1 - l)) return M;
          continue;
        }
      } else if (r[l] === "shift") {
  ...
  function Br(t, e, i, s, n) {
    ...
    return i && (o[ht[n][2]] += i, o[ht[n][3]] -= i), s && (o = wn(o, I(Q(s) ? s[n] : s))), 
    o;
  }
  function Nr(t, e, i, s) {
    const [n, o, r, a] = ht[s], [l] = vn(t, e), h = lt(l);
    return [ "auto", "scroll" ].includes(c(l, `overflow-${o}`)) && (h[r] -= l[`scroll${St(r)}`], 
    h[a] = h[r] + l[`scroll${St(n)}`]), h[r] += i, h[a] -= i, h;
  }
  function vn(t, e) {
  ...
  function wn(...t) {
    let e = {};
    for (const i of t) for (const [, , s, n] of ht) e[s] = Math.max(e[s] || 0, i[s]), 
  ...
  var jr = {
    ...
    connected() {
      p(this.$el, "role", this.role), this.date = S(Date.parse(this.$props.date)), this.end = !1, 
      this.start();
    },
    disconnected() {
      this.stop();
    ...
    methods: {
      ...
      update() {
        ...
        for (const e of Wr) {
          ...
          s = s.length < 2 ? `0${s}` : s, i.textContent !== s && (s = s.split(""), s.length !== i.children.length && Lt(i, s.map(() => "<span></span>").join("")), 
  ...
  const Y = {};
  Y.events = Y.watch = Y.observe = Y.created = Y.beforeConnect = Y.connected = Y.beforeDisconnect = Y.disconnected = Y.destroy = ds, 
  Y.args = function(t, e) {
    return e !== !1 && ds(e || t);
  ...
  function $n(t, e, i) {
    return Y.computed(it(t) ? t.call(i, i) : t, it(e) ? e.call(i, i) : e);
  }
  function ds(t, e) {
  ...
  function ze(t, e, i) {
    const s = {};
    if (it(e) && (e = e.options), e.extends && (t = ze(t, e.extends, i)), e.mixins) for (const o of e.mixins) t = ze(t, o, i);
    for (const o in t) n(o);
    for (const o in e) gt(t, o) || n(o);
    function n(o) {
      s[o] = (Y[o] || qr)(t[o], e[o], i);
    }
    return s;
  }
  function fe(t, e = []) {
  ...
  function fs(t, e) {
    return t === Boolean ? zi(e) : t === Number ? $t(e) : t === "list" ? Vr(e) : t === Object && N(e) ? fe(e) : t ? t(e) : e;
  }
  const Ur = /,(?![^(]*\))/;
  function Vr(t) {
    return Q(t) ? t : N(t) ? t.split(Ur).map(e => vt(e) ? $t(e) : zi(e.trim())) : [ t ];
  }
  function Yr(t) {
  ...
  function Jr(t, e) {
    for (const {read: i, write: s, events: n = []} of t._updates) {
      ...
      let o;
      i && (o = i.call(t, t._data, e), o && xt(o) && mt(t._data, o)), s && o !== !1 && K.write(() => {
        t._connected && s.call(t, t._data, e);
      });
    }
  }
  function ct(t) {
    return je(de, t, "resize");
  }
  function He(t) {
    return je(tn, t);
  }
  ...
  function Le(t = {}) {
    return He({
      handler: function(e, i) {
        ...
        for (const o of T(it(s) ? s(this) : s)) z('[loading="lazy"]', o).slice(0, n - 1).forEach(r => Ce(r, "loading"));
  ...
  function gs(t) {
    return je((e, i) => os(i), t, "resize");
  }
  function We(t) {
    return je((e, i) => ({
      disconnect: b(Zr(e), "scroll", i, {
        passive: !0
      })
    }), t, "scroll");
  }
  ...
  function Zr(t) {
    return T(t).map(e => {
      const {ownerDocument: i} = e, s = Dt(e, !0);
  ...
  const ws = "uc-transition-leave", bs = "uc-transition-enter";
  function Sn(t, e, i, s = 0) {
    const n = $i(e, !0), o = {
      opacity: 1
    }, r = {
      opacity: 0
    }, a = u => () => n === $i(e) ? u() : Promise.reject(), l = a(async () => {
      $(e, ws), await Promise.all(Cn(e).map((u, d) => new Promise(f => setTimeout(() => D.start(u, r, i / 2, "ease").then(f), d * s)))), 
      O(e, ws);
    }), h = a(async () => {
      const u = st(e);
      $(e, bs), t(), c(B(e), {
      ...
      const d = B(e), f = st(e);
      c(e, "alignContent", "flex-start"), st(e, u);
      const v = Cn(e);
      c(d, r);
      const x = v.map(async (C, M) => {
        await ta(M * s), await D.start(C, o, i / 2, "ease");
      });
      u !== f && x.push(D.start(e, {
        height: f
  ...
  function $i(t, e) {
    return e && (t.dataset.transition = 1 + $i(t)), $t(t.dataset.transition) || 0;
  }
  function In(t) {
    return Promise.all(B(t).filter(D.inProgress).map(e => new Promise(i => H(e, "transitionend transitioncanceled", i))));
  }
  function Cn(t) {
  ...
  async function ea(t, e, i) {
    await Pn();
    let s = B(e);
    const n = s.map(f => Tn(f, !0)), o = {
      ...c(e, [ "height", "padding" ]),
      display: "block"
    };
    await Promise.all(s.concat(e).map(D.cancel)), t(), s = s.concat(B(e).filter(f => !m(s, f))), 
    await Promise.resolve(), K.flush();
    const r = p(e, "style"), a = c(e, [ "height", "padding" ]), [l, h] = ia(e, s, n), u = s.map(f => ({
      style: p(f, "style")
    }));
    s.forEach((f, v) => h[v] && c(f, h[v])), c(e, o), g(e, "scroll"), K.flush(), await Pn();
    const d = s.map((f, v) => P(f) === e && D.start(f, l[v], i, "ease")).concat(D.start(e, a, i, "ease"));
    try {
  ...
  function Tn(t, e) {
    ...
    return q(t) ? {
      ...
      pointerEvents: "none",
      position: "absolute",
      zIndex: i === "auto" ? Et(t) : i,
      ...En(t)
    } : !1;
  }
  function ia(t, e, i) {
    const s = e.map((o, r) => P(o) && r in i ? i[r] ? q(o) ? En(o) : {
      opacity: 0
    } : {
      opacity: q(o) ? 1 : 0
    } : !1), n = s.map((o, r) => {
      const a = P(e[r]) === t && (i[r] || Tn(e[r]));
      if (!a) return !1;
  ...
  var _n = {
    ...
    methods: {
      animate(t, e = this.$el) {
        ...
        return (i === "fade" ? Sn : i === "delayed-fade" ? (...n) => Sn(...n, 40) : i ? ea : () => (t(), 
  ...
  var na = {
    ...
    events: {
      ...
      handler(t) {
        t.type === "keydown" && t.keyCode !== _.SPACE || t.target.closest("a,button") && (t.preventDefault(), 
        this.apply(t.current));
      }
    },
    methods: {
      apply(t) {
        const e = this.getState(), i = On(t, this.attrItem, this.getState());
        oa(e, i) || this.setState(i);
      },
      getState() {
        return this.toggles.filter(t => y(t, this.cls)).reduce((t, e) => On(e, this.attrItem, t), {
          filter: {
            "": ""
          },
          sort: []
      ...
      async setState(t, e = !0) {
        ...
        await Promise.all(z(this.target, this.$el).map(i => {
          const s = () => {
            ra(t, i, B(i)), this.$update(this.$el);
          };
  ...
  function An(t, e) {
    return fe(G(t, e), [ "filter" ]);
  }
  function oa(t, e) {
    return [ "filter", "sort" ].every(i => ii(t[i], e[i]));
  }
  function ra(t, e, i) {
    const s = la(t);
    i.forEach(r => c(r, "display", s && !E(r, s) ? "none" : ""));
    const [n, o] = t.sort;
    if (n) {
      const r = ha(i, n, o);
      ii(r, i) || L(e, r);
  ...
  function On(t, e, i) {
    ...
    (ei(i.filter) || "" in i.filter) && (i.filter = {
      "": s || ""
    })) : i.filter = {
      "": s || ""
    }), X(o) || (i.sort = [ o, r ]), i;
  ...
  function la({filter: t}) {
    let e = "";
    return Nt(t, i => e += i || ""), e;
  }
  function ha(t, e, i) {
    return [ ...t ].sort((s, n) => G(s, e).localeCompare(G(n, e), void 0, {
      numeric: !0
    }) * (i === "asc" || -1));
  }
  function ca(t) {
  ...
  function Dn(t) {
    const e = b(t, "touchstart", s => {
      if (s.targetTouches.length !== 1 || E(s.target, 'input[type="range"')) return;
      let n = _t(s).y;
    ...
    return c(i, {
      ...
      touchAction: "none",
      paddingRight: fi(window) - i.clientWidth || ""
    }), () => {
      xs = !1, e(), c(i, {
        overflowY: "",
        touchAction: "",
  ...
  var Re = {
    ...
    computed: {
      ...
      hasTransition: ({animation: t}) => [ "slide", "reveal" ].some(e => dt(t[0], e))
    },
    methods: {
      async toggleElement(t, e, i) {
        try {
          return await Promise.all(T(t).map(s => {
            ...
            if (!g(s, `before${n ? "show" : "hide"}`, [ this ])) return Promise.reject();
            const o = (it(i) ? i : i === !1 || !this.hasAnimation ? ua : this.hasTransition ? da : fa)(s, n, this), r = n ? this.clsEnter : this.clsLeave;
            $(s, r), g(s, n ? "show" : "hide", [ this ]);
            const a = () => {
              O(s, r), g(s, n ? "shown" : "hidden", [ this ]);
            };
      ...
      _toggle(t, e) {
        ...
        e = !!e;
        let i;
        this.cls ? (i = m(this.cls, " ") || e !== y(t, this.cls), i && j(t, this.cls, m(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, 
        i && (t.hidden = !e)), z("[autofocus]", t).some(s => q(s) ? s.focus() || !0 : s.blur()), 
        i && g(t, "toggled", [ e, this ]);
      }
    }
  };
  function ua(t, e, {_toggle: i}) {
    return At.cancel(t), D.cancel(t), i(t, e);
  }
  async function da(t, e, {animation: i, duration: s, velocity: n, transition: o, _toggle: r}) {
    var a;
    const [l = "reveal", h = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [], u = [ [ "left", "right" ], [ "top", "bottom" ] ], d = u[m(u[0], h) ? 0 : 1], f = d[1] === h, x = [ "width", "height" ][u.indexOf(d)], C = `margin-${d[0]}`, M = `margin-${h}`;
    let wt = w(t)[x];
    const Qe = D.inProgress(t);
    await D.cancel(t), e && r(t, !0);
    const Mi = Object.fromEntries([ "padding", "border", "width", "height", "minWidth", "minHeight", "overflowY", "overflowX", C, M ].map(Qo => [ Qo, t.style[Qo] ])), pt = w(t), xe = S(c(t, C)), Jo = S(c(t, M)), Qt = pt[x] + Jo;
    !Qe && !e && (wt += Jo);
    const [Bi] = es(t, "<div>");
    c(Bi, {
      ...
      height: pt.height,
      width: pt.width,
      ...c(t, [ "overflow", "padding", "borderTop", "borderRight", "borderBottom", "borderLeft", "borderImage", M ])
    }), c(t, {
      padding: 0,
      border: 0,
      minWidth: 0,
    ...
    f && (c(t, C, Qt - wt + xe), Zo[C] = e ? xe : Qt + xe), !f ^ l === "reveal" && (c(Bi, C, -Qt + wt), 
    D.start(Bi, {
      [C]: e ? 0 : -Qt
    }, s, o));
    try {
      await D.start(t, Zo, s, o);
    } finally {
      c(t, Mi), re(Bi.firstChild), e || r(t, !1);
    }
  }
  function fa(t, e, i) {
  ...
  var $s = {
    ...
    events: [ {
      ...
      handler(t) {
        ...
        !i && s && oe(e) && !this.$el.contains(k(s)) ? this.hide() : E(e, this.selClose) && (t.preventDefault(), 
        this.hide());
      }
    }, {
      name: "toggle",
      ...
      handler() {
        ...
        const t = [ this.overlay && ga(this), this.overlay && Dn(this.$el), this.bgClose && ma(this), this.escClose && va(this) ];
      ...
      self: !0,
      handler() {
        oi(this.$el) || p(this.$el, "tabindex", "-1"), E(this.$el, ":focus-within") || this.$el.focus();
      }
    }, {
      name: "hidden",
      self: !0,
    ...
    methods: {
      ...
      show() {
        return this.container && P(this.$el) !== this.container ? (L(this.container, this.$el), 
        new Promise(t => requestAnimationFrame(() => this.show().then(t)))) : this.toggleElement(this.$el, !0, Mn);
      },
      hide() {
  ...
  function ma(t) {
    return b(document, ft, ({target: e}) => {
      Bt(nt) !== t || t.overlay && !t.$el.contains(e) || t.panel.contains(e) || H(document, `${Ot} ${mi} scroll`, ({defaultPrevented: i, type: s, target: n}) => {
        !i && s === Ot && e === n && t.hide();
      }, !0);
    });
  }
  ...
  function wa(t, e, i, {animation: s, easing: n}) {
    ...
    return {
      ...
      show(u, d = 0, f) {
        const v = f ? "linear" : n;
        return u -= Math.round(u * tt(d, -1, 1)), this.translate(d), yi(e, "itemin", {
          percent: d,
          duration: u,
          timing: v,
          dir: i
          ...
          h || (h = x), Promise.all([ D.start(e, l[1], u, v), D.start(t, l[0], u, v) ]).then(() => {
            this.reset(), h();
          }, A);
        });
      },
      ...
      translate(u) {
        this.reset();
        const d = r(u, i);
        c(e, d[1]), c(t, d[0]), yi(e, "itemtranslatein", {
          percent: u,
          dir: i
    ...
    methods: {
      startAutoplay() {
        this.stopAutoplay(), this.interval = setInterval(() => {
          this.stack.length || this.draggable && E(this.$el, ":focus-within") && !E(this.$el, ":focus") || this.pauseOnHover && E(this.$el, ":hover") || this.show("next");
  ...
  const Ue = {
    ...
    passive: !0,
    capture: !0
  }, xa = "touchstart mousedown", ks = "touchmove mousemove", Nn = "touchend touchcancel mouseup click input scroll", zn = t => t.preventDefault();
  var $a = {
    props: {
      draggable: Boolean
    },
    ...
    events: [ {
      ...
      handler(t) {
        !this.draggable || this.parallax || !yt(t) && ya(t.target) || t.target.closest(Te) || t.button > 0 || this.length < 2 || this.start(t);
      }
    }, {
      name: "dragstart",
      handler(t) {
    ...
    methods: {
      start() {
        ...
        b(document, ks, this.move, Ue), b(document, Nn, this.end, Bn), c(this.list, "userSelect", "none");
      },
      move(t) {
        const e = this.pos - this.drag;
        if (e === 0 || this.prevPos === this.pos || !this.dragging && Math.abs(e) < this.threshold) return;
        this.dragging || b(this.list, "click", zn, Ue), t.cancelable && t.preventDefault(), 
        this.dragging = !0, this.dir = e < 0 ? 1 : -1;
        ...
        let d;
        for (const f of [ this.index, this.prevIndex ]) m([ o, s ], f) || (g(i[f], "itemhidden", [ this ]), 
        u && (d = !0, this.prevIndex = s));
        (this.index === s && this.prevIndex !== s || d) && g(i[this.index], "itemshown", [ this ]), 
        h && (this.prevIndex = s, this.index = o, u || (g(a, "beforeitemhide", [ this ]), 
        g(a, "itemhide", [ this ])), g(l, "beforeitemshow", [ this ]), g(l, "itemshow", [ this ])), 
        this._transitioner = this._translate(Math.abs(this.percent), a, !u && l);
      },
      end() {
        if (Pt(document, ks, this.move, Ue), Pt(document, Nn, this.end, Bn), this.dragging) if (this.dragging = null, 
        this.index === this.prevIndex) this.percent = 1 - this.percent, this.dir *= -1, 
        this._show(!1, this.index, !0), this._transitioner = null; else {
          const t = (V ? this.dir * (V ? 1 : -1) : this.dir) < 0 == this.prevPos > this.pos;
          this.index = t ? this.index : this.prevIndex, t && (this.percent = 1 - this.percent), 
          this.show(this.dir > 0 && !t || this.dir < 0 && t ? "next" : "previous", !0);
        }
        setTimeout(() => Pt(this.list, "click", zn, Ue)), c(this.list, {
          userSelect: ""
  ...
  function Sa(t, e) {
    for (const {name: i, handler: s, immediate: n = !0} of t._watches) (t._initial && n || gt(e, i) && !ii(e[i], t[i])) && s.call(t, t[i], e[i]);
    t._initial = !1;
  }
  function Ia(t) {
  ...
  function Ln(t, e, i) {
    t._hasComputed = !0, Object.defineProperty(t, e, {
      ...
      get() {
        ...
        return gt(s, e) || (s[e] = (i.get || i).call(t, n, o)), s[e];
      },
      set(s) {
        const {_computed: n} = t;
  ...
  let Ss, Ve;
  function Ea() {
    Ss || (Ve = new Set, Ss = new MutationObserver(() => {
      for (const t of Ve) Fe(t, "computed");
    }), Ss.observe(document, {
      subtree: !0,
      childList: !0
    }));
  ...
  function Pa(t) {
    t._events = [];
    for (const e of t.$options.events || []) if (gt(e, "handler")) jn(t, e); else for (const i in e) jn(t, e[i], i);
  }
  function _a(t) {
  ...
  function jn(t, e, i) {
    ...
    n = it(n) ? n.call(t, t) : n || t.$el, !(!n || Q(n) && !n.length || h && !h.call(t)) && t._events.push(b(n, s, l ? N(l) ? l : l.call(t, t) : null, N(o) ? t[o] : o.bind(t), {
      passive: a,
      capture: r,
      self: u
    }));
  ...
  function Aa(t) {
    t._observers = [];
    for (const e of t.$options.observe || []) if (gt(e, "handler")) qn(t, e); else for (const i of e) qn(t, i);
  }
  function Rn(t, ...e) {
    t._observers.push(...e);
  }
  ...
  function qn(t, e) {
    ...
    it(s) && !gt(t, l) && Ln(t, l, () => s.call(t, t)), n = N(n) ? t[n] : n.bind(t), 
    it(o) && (o = o.call(t, t));
    const h = gt(t, l) ? t[l] : s, u = i(h, n, o, a);
    it(s) && Q(t[l]) && u.unobserve && Hn(t, {
      handler: Da(u),
      immediate: !1
    }, l), Rn(t, u);
  }
  ...
  function Un(t) {
    ...
    for (const a in s) {
      const l = Mt(a);
      let h = G(n, l);
      X(h) || (h = s[a] === Boolean && h === "" ? !0 : fs(s[a], h), !(l === "target" && dt(h, "_")) && (e[a] = h));
    }
    const r = fe(G(n, o), i);
    for (const a in r) {
      const l = ye(a);
      X(s[l]) || (e[l] = fs(s[l], r[a]));
    }
    return e;
  }
  const Ba = rt((t, e) => {
  ...
  function Na(t) {
    ...
    const {attributes: r, filter: a} = Ba(s, n), l = new MutationObserver(h => {
      ...
      h.some(({attributeName: d}) => {
        ...
        return (f === s ? r : [ ye(f), ye(d) ]).some(v => !X(u[v]) && u[v] !== i[v]);
      }) && t.$reset();
    });
    l.observe(o, {
      attributes: !0,
  ...
  function Is(t) {
    t._connected || (Ma(t), ge(t, "beforeConnect"), t._connected = !0, Pa(t), Yr(t), 
    ka(t), Aa(t), Na(t), Ca(t), ge(t, "connected"), Fe(t));
  }
  function Cs(t) {
    t._connected && (ge(t, "beforeDisconnect"), _a(t), Gr(t), Oa(t), Ta(t), ge(t, "disconnected"), 
    t._connected = !1);
  }
  let za = 0;
  function Vn(t, e = {}) {
    e.data = La(e, t.constructor.options), t.$options = ze(t.constructor.options, e, t), 
    t.$props = {}, t._uid = za++, Fa(t), Ha(t), Ia(t), ge(t, "created"), e.el && t.$mount(e.el);
  }
  function Fa(t) {
  ...
  function La({data: t = {}}, {args: e = [], props: i = {}}) {
    Q(t) && (t = t.slice(0, e.length).reduce((s, n, o) => (xt(n) ? mt(s, n) : s[e[o]] = n, 
    s), {}));
    for (const s in t) X(t[s]) ? delete t[s] : i[s] && (t[s] = fs(i[s], t[s]));
    return t;
  }
  const ut = function(t) {
    Vn(this, t);
  };
  ut.util = Lr, ut.options = {}, ut.version = "3.19.1";
  const Wa = "uc-", Yt = "__uikit__", me = {};
  function Yn(t, e) {
    var i;
    const s = Wa + Mt(t);
    if (!e) return xt(me[s]) && (me[s] = ut.extend(me[s])), me[s];
    t = ye(t), ut[t] = (o, r) => Ye(t, o, r);
    const n = xt(e) ? {
      ...e
    } : e.options;
    return n.id = s, n.name = t, (i = n.install) == null || i.call(n, ut, n, t), ut._initialized && !n.functional && requestAnimationFrame(() => Ye(t, `[${s}],[data-${s}]`)), 
    me[s] = n;
  }
  function Ye(t, e, i, ...s) {
    const n = Yn(t);
  ...
  function Ra(t, e) {
    var i;
    (i = t[Yt]) == null || delete i[e.$options.name], ei(t[Yt]) || delete t[Yt];
  }
  function qa(t) {
    t.component = Yn, t.getComponents = Xt, t.getComponent = Si, t.update = Xn, t.use = function(i) {
      if (!i.installed) return i.call(null, this), i.installed = !0, this;
    }, t.mixin = function(i, s) {
      s = (N(s) ? this.component(s) : s) || this, s.options = ze(s.options, i);
    }, t.extend = function(i) {
      i || (i = {});
      const s = this, n = function(r) {
        Vn(this, r);
      };
      return n.prototype = Object.create(s.prototype), n.prototype.constructor = n, n.options = ze(s.options, i), 
  ...
  function Xn(t, e) {
    ...
    for (const i of _e(t).reverse()) Gn(i, e);
    kt(t, i => Gn(i, e));
  }
  function Gn(t, e) {
    const i = Xt(t);
    for (const s in i) Fe(i[s], e);
  }
  function Ua(t) {
    t.prototype.$mount = function(e) {
      const i = this;
      ja(e, i), i.$options.el = e, document.contains(e) && Is(i);
    }, t.prototype.$destroy = function(e = !1) {
      const i = this, {el: s} = i.$options;
      s && Cs(i), ge(i, "destroy"), Ra(s, i), e && at(i.$el);
    }, t.prototype.$create = Ye, t.prototype.$emit = function(e) {
      Fe(this, e);
    }, t.prototype.$update = function(e = this.$el, i) {
      Xn(e, i);
    }, t.prototype.$reset = function() {
      Cs(this), Is(this);
    }, t.prototype.$getComponent = Si, Object.defineProperties(t.prototype, {
      $el: {
        get() {
  ...
  function Gt(t, e = null) {
    return (e == null ? void 0 : e.id) || `${t.$options.id}-${Va++}`;
  }
  var Ya = {
    i18n: {
      next: "Next slide",
    ...
    watch: {
      ...
      navItems(t) {
        for (const e of t) {
          const i = G(e, this.attrItem), s = k("a,button", e) || e;
          let n, o = null;
          if (vt(i)) {
            const r = $t(i), a = this.slides[r];
            a && (a.id || (a.id = Gt(this, a)), o = a.id), n = this.t("slideX", S(i) + 1), p(s, "role", "tab");
          } else this.list && (this.list.id || (this.list.id = Gt(this, this.list)), o = this.list.id), 
          n = this.t(i);
          p(s, {
            "aria-controls": o,
    ...
    events: [ {
      ...
      handler(t) {
        t.target.closest("a,button") && (t.type === "click" || t.keyCode === _.SPACE) && (t.preventDefault(), 
        this.show(G(t.current, this.attrItem)));
      }
    }, {
      name: "itemshow",
      handler: "updateNav"
      ...
      handler(t) {
        const {current: e, keyCode: i} = t, s = G(e, this.attrItem);
        if (!vt(s)) return;
    ...
    methods: {
      updateNav() {
        ...
        for (const e of this.navItems) {
          ...
          if (vt(i)) {
            const o = $t(i) === t;
            j(e, this.clsActive, o), j(s, "uc-disabled", this.parallax), p(s, {
              "aria-selected": o,
              tabindex: o && !this.parallax ? null : -1
            }), o && s && E(P(e), ":focus-within") && s.focus();
          } else j(e, "uc-invisible", this.finite && (i === "previous" && t === 0 || i === "next" && t >= this.maxIndex));
        }
      }
    }
  }, Jn = {
    ...
    events: {
      ...
      itemhidden({target: t}) {
        O(t, this.clsLeave, this.clsSlideActive);
      }
    },
    methods: {
      show(t, e = !1) {
        ...
        if (this.dir = Xa(t, r), this.prevIndex = r, this.index = l, a && !g(a, "beforeitemhide", [ this ]) || !g(h, "beforeitemshow", [ this, a ])) {
          this.index = this.prevIndex, o();
          return;
        }
        const u = this._show(a, h, e).then(() => {
          a && g(a, "itemhidden", [ this ]), g(h, "itemshown", [ this ]), s.shift(), this._transitioner = null, 
          requestAnimationFrame(() => s.length && this.show(s.shift(), !0));
        });
        return a && g(a, "itemhide", [ this ]), g(h, "itemshow", [ this ]), u;
      },
      ...
      _getTransitioner(t = this.prevIndex, e = this.index, i = this.dir || 1, s = this.transitionOptions) {
        return new this.Transitioner(Ie(t) ? this.slides[t] : t, Ie(e) ? this.slides[e] : e, i * (V ? -1 : 1), s);
      }
    }
  };
  function Xa(t, e) {
  ...
  var Zn = {
    ...
    created() {
      ...
      const i = k("[uc-close]", t), s = this.t("close");
    ...
    events: [ {
      ...
      self: !0,
      handler() {
        this.hideControls(), O(this.slides, this.clsActive), D.stop(this.slides);
      }
    }, {
      name: "hidden",
      self: !0,
      ...
      handler({keyCode: t}) {
        ...
        let e = -1;
        t === _.LEFT ? e = "previous" : t === _.RIGHT ? e = "next" : t === _.HOME ? e = 0 : t === _.END && (e = "last"), 
        ~e && this.show(e);
      }
    }, {
      name: "beforeitemshow",
      handler(t) {
        ...
        this.animation = Qn.scale, O(t.target, this.clsActive), this.stack.splice(1, 0, this.index));
      }
    }, {
      name: "itemshow",
      handler() {
      ...
      async handler(t, e) {
        ...
        } else if (s === "iframe" || i.match(/\.(html|php)($|\?)/i)) this.setItem(e, Xe("iframe", {
          src: i,
          allowfullscreen: "",
          class: "uc-lightbox-iframe",
          ...r
        })); else if (a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) this.setItem(e, Xe("iframe", {
    ...
    methods: {
      ...
      setItem(t, e) {
        g(this.$el, "itemloaded", [ this, Lt(this.getSlide(t), e) ]);
      },
      getSlide(t) {
      ...
      showControls() {
        clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), 
        $(this.$el, "uc-active", "uc-transition-active");
      },
      hideControls() {
        O(this.$el, "uc-active", "uc-transition-active");
      }
    }
  };
  function Xe(t, e) {
  ...
  function Ja(t, e) {
    t.lightboxPanel || t.component("lightboxPanel", to), mt(e.props, t.component("lightboxPanel").options.props);
  }
  function eo(t) {
    const e = {};
    for (const i of [ "href", "caption", "type", "poster", "alt", "attrs" ]) e[i === "href" ? "source" : i] = G(t, i);
  ...
  var Ka = {
    ...
    created() {
      ...
      this.$mount(L(i, `<div class="${this.clsMsg}${this.status ? ` ${this.clsMsg}-${this.status}` : ""}" role="alert"> <a href class="${this.clsClose}" data-uc-close></a> <div>${this.message}</div> </div>`));
    },
    async connected() {
      const t = S(c(this.$el, this.marginProp));
      await D.start(c(this.$el, this.startProps), {
        opacity: 1,
        [this.marginProp]: t
    ...
    methods: {
      async close(t) {
        const e = i => {
          const s = P(i);
          g(i, "close", [ this ]), at(i), s != null && s.hasChildNodes() || at(s);
        };
        this.timer && clearTimeout(this.timer), t || await D.start(this.$el, this.startProps), 
        e(this.$el);
      }
    }
  };
  ...
  var ve = {
    ...
    connected() {
      const t = io(this.media, this.$el), e = io(this.mediaMax, this.$el, "max");
      if (this.matchMedia = !0, t || e) {
        const i = t ? e ? t + " and " + e : t : e;
        this.mediaObj = window.matchMedia(i);
        const s = () => {
          this.matchMedia = this.mediaObj.matches, g(this.$el, Ht("mediachange", !1, !0, [ this.mediaObj ]));
        };
  ...
  function io(t, e, i = "min") {
    if (N(t)) {
      if (dt(t, "@")) t = S(c(e, `--uc-breakpoint-${t.substr(1)}`)); else if (isNaN(t)) return t;
    }
    return t && vt(t) ? `(${i}-width: ${t}px)` : "";
  }
  function so(t) {
  ...
  var oo = {
    mixins: [ ve ],
    props: co(no(Ii), "list"),
    data: co(no(Ii), void 0),
    computed: {
      props(t, e) {
        const i = {};
        for (const n in t) n in Ii && !X(t[n]) && (i[n] = t[n].slice());
        const s = {};
    ...
    methods: {
      ...
      getCss(t) {
        ...
        return e.willChange = Object.keys(e).map(ai).join(","), e;
      }
    }
  };
  function Ci(t, e, i) {
    ...
    return t === "x" || t === "y" ? (t = `translate${St(t)}`, n = o => S(S(o).toFixed(s === "px" ? 0 : 6))) : t === "scale" && (s = "", 
    n = o => {
      var r;
      return Ei([ o ]) ? U(o, "width", e, !0) / e[`offset${(r = o.endsWith) != null && r.call(o, "vh") ? "Height" : "Width"}`] : S(o);
    }), i.length === 1 && i.unshift(t === "scale" ? 1 : 0), i = we(i, n), (o, r) => {
      o.transform = `${o.transform || ""} ${t}(${Ge(i, r)}${s})`;
    };
  }
  function Ts(t, e, i) {
    return i.length === 1 && i.unshift(Je(e, t, "")), i = we(i, s => Qa(e, s)), (s, n) => {
      const [o, r, a] = ho(i, n), l = o.map((h, u) => (h += a * (r[u] - h), u === 3 ? S(h) : parseInt(h, 10))).join(",");
      s[t] = `rgba(${l})`;
    };
  }
  function Qa(t, e) {
    return Je(t, "color", e).split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(S);
  }
  function Jt(t, e, i) {
  ...
  function tl(t, e, i) {
    return i.length === 1 && i.unshift(Je(e, t, "")), i = we(i), (s, n) => {
      s[t] = Ge(i, n);
    };
  }
  function el(t, e, i) {
    i.length === 1 && i.unshift(0);
    const s = Ei(i), n = so(e);
    return i = we(i.reverse(), o => (o = S(o), s === "%" ? o * n / 100 : o)), i.some(([o]) => o) ? (c(e, "strokeDasharray", n), 
    (o, r) => {
  ...
  function ro(t, e, i, s) {
    ...
    if (Je(e, "backgroundSize", "") === "cover") return il(t, e, i, s);
    const r = {};
    for (const a of o) r[a] = ao(e, a);
    return lo(o, r, s);
  }
  function il(t, e, i, s) {
    const n = sl(e);
  ...
  function Ei(t, e) {
    var i;
    for (const s of t) {
      const n = (i = s.match) == null ? void 0 : i.call(s, nl);
      if (n) return n[1];
    }
    return e;
  }
  ...
  var ol = {
    ...
    computed: {
      target: ({target: t}, e) => fo(t && J(t, e) || e),
      start({start: t}) {
    ...
    observe: [ gs(), We({
      ...
      target: ({$el: t, target: e}) => [ t, e, Dt(e, !0) ]
    }) ],
    update: {
      read({percent: t}, e) {
        ...
        const i = t;
        return t = uo(bi(this.target, this.start, this.end), this.easing), {
          percent: t,
  ...
  function fo(t) {
    return t ? "offsetTop" in t ? t : fo(P(t)) : document.documentElement;
  }
  var po = {
    props: {
      parallax: Boolean,
    ...
    update: {
      write() {
        ...
        const t = this.parallaxTarget, e = U(this.parallaxStart, "height", t, !0), i = U(this.parallaxEnd, "height", t, !0), s = uo(bi(t, e, i), this.parallaxEasing), [n, o] = this.getIndexAt(s), r = this.getValidIndex(n + Math.ceil(o)), a = this.slides[n], l = this.slides[r], {triggerShow: h, triggerShown: u, triggerHide: d, triggerHidden: f} = rl(this);
        if (~this.prevIndex) for (const x of new Set([ this.index, this.prevIndex ])) m([ r, n ], x) || (d(this.slides[x]), 
        f(this.slides[x]));
        const v = this.prevIndex !== n || this.index !== r;
        this.dir = 1, this.prevIndex = n, this.index = r, a !== l && d(a), h(l), v && u(a), 
        this._translate(a === l ? 1 : o, a, l);
      },
      events: [ "scroll", "resize" ]
    },
    methods: {
  ...
  function rl(t) {
    ...
    function n(l) {
      y(l, s) && (r(l), a(l)), y(l, e) || (g(l, "beforeitemshow", [ t ]), g(l, "itemshow", [ t ]));
    }
    function o(l) {
      y(l, i) && g(l, "itemshown", [ t ]);
    }
    function r(l) {
      y(l, e) || n(l), y(l, i) && o(l), y(l, s) || (g(l, "beforeitemhide", [ t ]), g(l, "itemhide", [ t ]));
    }
    function a(l) {
      y(l, s) && g(l, "itemhidden", [ t ]);
    }
  }
  var go = {
    update: {
  ...
  function al(t, e, i, {center: s, easing: n, list: o}) {
    const r = t ? Ke(t, o, s) : Ke(e, o, s) + w(e).width * i, a = e ? Ke(e, o, s) : r + w(t).width * i * (V ? -1 : 1);
    let l;
    return {
      dir: i,
      show(h, u = 0, d) {
        const f = d ? "linear" : n;
        return h -= Math.round(h * tt(u, -1, 1)), this.translate(u), u = t ? u : tt(u, 0, 1), 
        Ps(this.getItemIn(), "itemin", {
          percent: u,
          duration: h,
          timing: f,
          dir: i
      ...
      translate(h) {
        ...
        c(o, "transform", W(tt(-a + (u - u * h), -be(o), w(o).width) * (V ? -1 : 1), "px"));
        const d = this.getActives(), f = this.getItemIn(), v = this.getItemIn(!0);
        h = t ? tt(h, -1, 1) : 0;
        for (const x of B(o)) {
          const C = m(d, x), M = x === f, wt = x === v, Qe = M || !wt && (C || i * (V ? -1 : 1) === -1 ^ Pi(x, o) > Pi(t || e));
          Ps(x, `itemtranslate${Qe ? "in" : "out"}`, {
            dir: i,
      ...
      getItemIn(h = !1) {
        let u = this.getActives(), d = wo(o, Ke(e || t, o, s));
        if (h) {
          const f = u;
          u = d, d = f;
        }
      ...
      getActives() {
        return wo(o, Ke(t || e, o, s));
      }
    };
  }
  function Ke(t, e, i) {
    const s = Pi(t, e);
    return i ? s - ll(t, e) : Math.min(s, vo(e));
  }
  function vo(t) {
    return Math.max(0, be(t) - w(t).width);
  }
  function be(t, e) {
  ...
  var hl = {
    ...
    computed: {
      ...
      maxIndex() {
        ...
        let t = 0;
        const e = vo(this.list), i = bt(this.slides, s => {
          if (t >= e) return !0;
          t += w(s).width;
        });
      ...
      sets({sets: t}) {
        ...
        for (let n = 0; n < this.length; n++) {
          ...
          e + o > s && (e = 0), this.center ? e < s / 2 && e + o + w(this.slides[ot(+n + 1, this.slides)]).width / 2 > s / 2 && (i.push(+n), 
    ...
    methods: {
      ...
      updateActiveClasses(t = this.index) {
        ...
        for (const s of this.slides) {
          ...
          for (const o of z(Ee, s)) gt(o, "_tabindex") || (o._tabindex = p(o, "tabindex")), 
          p(o, "tabindex", n ? o._tabindex : -1);
        }
      },
      getValidIndex(t = this.index, e = this.prevIndex) {
      ...
      getIndexAt(t) {
        let e = -1;
        const i = this.center ? be(this.list) - (w(this.slides[0]).width / 2 + w(Bt(this.slides)).width / 2) : be(this.list, this.maxIndex);
        let s = t * i, n = 0;
        do {
  ...
  function cl(t, e) {
    ...
    const {width: i} = w(t);
    if (!e) return Math.ceil(be(t)) < Math.trunc(i + ul(t));
    const s = B(t), n = Math.trunc(i / 2);
    for (const o in s) {
      const r = s[o], a = w(r).width, l = new Set([ r ]);
      let h = 0;
      for (const u of [ -1, 1 ]) {
        let d = a / 2, f = 0;
        for (;d < n; ) {
  ...
  var bo = {
    ...
    events: [ {
      ...
      handler({type: t, detail: {percent: e, duration: i, timing: s, dir: n}}) {
        K.read(() => {
          if (!this.matchMedia) return;
          const o = this.getCss($o(t, n, e)), r = this.getCss(xo(t) ? .5 : n > 0 ? 1 : 0);
          K.write(() => {
            c(this.$el, o), D.start(this.$el, r, i, s).catch(A);
          });
        });
      }
    }, {
  ...
  var dl = {
    ...
    update: {
      write(t) {
        ...
        u !== !1 && (u && o === u || (r !== h ? (h.remove(o), t.moved = l) : delete t.moved, 
    ...
    methods: {
      init(t) {
        ...
        !n || s || i > 0 || Ui(e) || e.closest(`.${this.clsNoDrag}`) || this.handle && !e.closest(this.handle) || (t.preventDefault(), 
        this.touched = new Set([ this ]), this.placeholder = n, this.origin = {
          target: e,
          index: Et(n),
          ...this.pos
        }, b(document, gi, this.move), b(document, Ot, this.end), this.threshold || this.start(t));
      },
      start(t) {
        this.drag = vl(this.$container, this.placeholder);
        const {left: e, top: i} = w(this.placeholder);
        mt(this.origin, {
          offsetLeft: this.pos.x - e,
          offsetTop: this.pos.y - i
        }), $(this.drag, this.clsDrag, this.clsCustom), $(this.placeholder, this.clsPlaceholder), 
        $(this.items, this.clsItem), $(document.documentElement, this.clsDragState), g(this.$el, "start", [ this, this.placeholder ]), 
        gl(this.pos), this.move(t);
      },
      move(t) {
        this.drag ? this.$emit("move") : (Math.abs(this.pos.x - this.origin.x) > this.threshold || Math.abs(this.pos.y - this.origin.y) > this.threshold) && this.start(t);
      },
      end() {
        if (Pt(document, gi, this.move), Pt(document, Ot, this.end), !this.drag) return;
        ml();
        const t = this.getSortable(this.placeholder);
        this === t ? this.origin.index !== Et(this.placeholder) && g(this.$el, "moved", [ this, this.placeholder ]) : (g(t.$el, "added", [ t, this.placeholder ]), 
        g(this.$el, "removed", [ this, this.placeholder ])), g(this.$el, "stop", [ this, this.placeholder ]), 
      ...
      insert(t, e) {
        ...
        const i = () => e ? hi(e, t) : L(this.target, t);
        this.animate(i);
      },
      remove(t) {
  ...
  function wl(t, e) {
    return t[bt(t, i => si(e, w(i)))];
  }
  function bl(t, e, i, s, n, o) {
    if (!B(t).length) return;
    const r = w(e);
    if (!o) return xl(t, i) || n < r.top + r.height / 2 ? e : e.nextElementSibling;
    const a = w(i), l = ko([ r.top, r.bottom ], [ a.top, a.bottom ]), [h, u, d, f] = l ? [ s, "width", "left", "right" ] : [ n, "height", "top", "bottom" ], v = a[u] < r[u] ? r[u] - a[u] : 0;
  ...
  function xl(t, e) {
    ...
    const s = B(t), n = s.some((o, r) => {
      ...
      return s.slice(r + 1).some(l => {
        const h = w(l);
        return !ko([ a.left, a.right ], [ h.left, h.right ]);
      });
    });
    return i && at(e), n;
  }
    ...
    methods: {
      positionAt(t, e, i) {
        ...
        const n = [ this.flip && "flip", this.shift && "shift" ], o = {
          element: [ this.inset ? this.dir : pi(this.dir), this.align ],
      ...
      getPositionOffset(t = this.$el) {
        return U(this.offset === !1 ? c(t, "--uc-position-offset") : this.offset, this.axis === "x" ? "width" : "height", t) * (m([ "left", "top" ], this.dir) ? -1 : 1) * (this.inset ? -1 : 1);
      },
      getShiftOffset(t = this.$el) {
        return this.align === "center" ? 0 : U(c(t, "--uc-position-shift-offset"), this.axis === "y" ? "width" : "height", t) * (m([ "left", "top" ], this.align) ? 1 : -1);
      },
      getViewportOffset(t) {
        return U(c(t, "--uc-position-viewport-offset"));
      }
    }
  };
  function $l(t) {
    const e = Dt(t), {scrollTop: i} = e;
    return () => {
  ...
  var yl = {
    ...
    methods: {
      show() {
        ...
        if (!e) return;
        const i = p(this.$el, "title"), s = b(this.$el, [ "blur", Ne ], o => !yt(o) && this.hide());
        this.reset = () => {
          p(this.$el, {
            title: i,
      ...
      async hide() {
        var t;
        E(this.$el, "input:focus") || (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && await this.toggleElement(this.tooltip, !1, !1), 
        (t = this.reset) == null || t.call(this), at(this.tooltip), this.tooltip = null);
      },
      async _show(t, e) {
        this.tooltip = L(this.container, `<div id="${e}" class="uc-${this.$options.name}" role="tooltip"> <div class="uc-${this.$options.name}-inner">${t}</div> </div>`), 
        b(this.tooltip, "toggled", (i, s) => {
          if (!s) return;
          const n = () => this.positionAt(this.tooltip, this.$el);
          n();
          const [o, r] = Sl(this.tooltip, this.$el, this.pos);
          this.origin = this.axis === "y" ? `${pi(o)}-${r}` : `${r}-${pi(o)}`;
          const a = [ H(document, `keydown ${ft}`, this.hide, !1, l => l.type === ft && !this.$el.contains(l.target) || l.type === "keydown" && l.keyCode === _.ESC), b([ document, ...Ut(this.$el) ], "scroll", n, {
            passive: !0
          }) ];
  ...
  var Cl = {
    ...
    events: {
      change(t) {
        E(t.target, 'input[type="file"]') && (t.preventDefault(), t.target.files && this.upload(t.target.files), 
        t.target.value = "");
      },
      drop(t) {
        _i(t);
      ...
      dragleave(t) {
        _i(t), O(this.$el, this.clsDragover);
      }
    },
    methods: {
      async upload(t) {
          ...
          try {
            const o = await El(this.url, {
              ...
              beforeSend: r => {
                ...
                for (const l of [ "loadStart", "load", "loadEnd", "abort" ]) b(a, l.toLowerCase(), this[l]);
  ...
  function Pl(t, e) {
    return new Promise((i, s) => {
      ...
      b(n, "load", () => {
        n.status === 0 || n.status >= 200 && n.status < 300 || n.status === 304 ? i(n) : s(mt(Error(n.statusText), {
          xhr: n,
          status: n.status
        }));
      }), b(n, "error", () => s(mt(Error("Network Error"), {
        xhr: n
      }))), b(n, "timeout", () => s(mt(Error("Network Timeout"), {
        xhr: n
      }))), n.send(e.data);
    });
  }
  var _l = {
    connected() {
      var t;
      this.registerObserver(de(((t = this.$options.resizeTargets) == null ? void 0 : t.call(this)) || this.$el, () => this.$emit("resize")));
    }
  }, Al = {
    mixins: [ et, ve, _l ],
    props: {
      ...Object.fromEntries([ "duration", "x", "y", "translateX", "translateY", "color", "background" ].map(t => [ t, null ])),
      y: "list"
    },
    setup(t) {
      const e = t.x, i = t.y;
    ...
    connected() {
      this.animation = te(this.animeOptions), this.animation.pause();
    },
    disconnected() {
      re(this.wrapper.childNodes);
    },
    update: {
      read() {
        return {
      ...
      write({hide: t}) {
        t ? "reset" in this.animation && typeof this.animation.reset == "function" && this.animation.reset() : this.animation.restart();
      },
      events: [ "resize" ]
    }
  }, Ol = Object.freeze({
  ...
  function Dl(t) {
    le && window.MutationObserver && (document.body ? requestAnimationFrame(() => Co(t)) : new MutationObserver((e, i) => {
  ...
  function Co(t) {
    g(document, "uikit:init", t), document.body && kt(document.body, To), new MutationObserver(e => e.forEach(Ml)).observe(document, {
      subtree: !0,
      childList: !0
  ...
  function Ml({addedNodes: t, removedNodes: e}) {
    for (const i of t) kt(i, To);
    for (const i of e) kt(i, Nl);
  }
  function Bl({target: t, attributeName: e}) {
    ...
    if (s) {
      ...
      (i = Si(t, s)) == null || i.$destroy();
    }
  }
  function To(t) {
    const e = Xt(t);
    for (const i in Xt(t)) Is(e[i]);
  ...
  var Po = {
    ...
    events: [ {
      ...
      async handler(t) {
        var e;
        t.type === "keydown" && t.keyCode !== _.SPACE || (t.preventDefault(), (e = this._off) == null || e.call(this), 
        this._off = Fl(t.target), await this.toggle(Et(this.toggles, t.current)), this._off());
      }
    }, {
      name: "shown hidden",
      self: !0,
  ...
  async function zl(t, e, {content: i, duration: s, velocity: n, transition: o}) {
    var r;
    i = ((r = t._wrapper) == null ? void 0 : r.firstElementChild) || k(i, t), t._wrapper || (t._wrapper = di(i, "<div>"));
    const a = t._wrapper;
    c(a, "overflow", "hidden");
    const l = S(c(a, "height"));
    await D.cancel(a), Ai(i, !1);
    const h = zt([ "marginTop", "marginBottom" ], d => c(i, d)) + w(i).height, u = l / h;
    s = (n * h + s) * (e ? 1 - u : u), c(a, "height", l), await D.start(a, {
      height: e ? h : 0
    }, s, o), re(i), delete t._wrapper, e || Ai(i, !0);
  }
  function Fl(t) {
    const e = Dt(t, !0);
    let i;
  ...
  var _o = {
    ...
    connected() {
      this.autoplay === "inview" && !Tt(this.$el, "preload") && (this.$el.preload = "none"), 
      R(this.$el, "iframe") && !Tt(this.$el, "allow") && (this.$el.allow = "autoplay"), 
      this.automute && rn(this.$el);
    },
    observe: [ He({
    ...
    observe: ct({
      target: ({$el: t}) => [ Ao(t) || P(t) ],
      filter: ({$el: t}) => !Oo(t)
    }),
    update: {
      read() {
        if (Oo(this.$el)) return;
        ...
        const {offsetHeight: r, offsetWidth: a} = Ao(i) || P(i), l = e(o, {
          width: a + (a % 2 ? 1 : 0),
          height: r + (r % 2 ? 1 : 0)
        });
  ...
  var Do = {
    ...
    computed: {
      boundary({boundary: t, boundaryX: e, boundaryY: i}, s) {
        return [ J(e || t, s) || window, J(i || t, s) || window ];
      },
      target({target: t, targetX: e, targetY: i}, s) {
        return e || (e = t || this.targetEl), i || (i = t || this.targetEl), [ e === !0 ? window : J(e, s), i === !0 ? window : J(i, s) ];
      }
    },
    created() {
      this.tracker = new Qs;
    ...
    connected() {
      $(this.$el, "uc-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = ql(this)), 
      this._style = Hi(this.$el.style, [ "width", "height" ]);
    },
    disconnected() {
    ...
    events: [ {
      ...
      handler({defaultPrevented: t, current: e}) {
        const {hash: i} = e;
        !t && i && oe(e) && !this.$el.contains(k(i)) && this.hide(!1);
      }
    }, {
      name: "beforescroll",
      handler() {
      ...
      handler() {
        ...
        const t = [ Ul(this), Vl(this), Xl(this), this.autoUpdate && Mo(this), this.closeOnScroll && Yl(this) ];
        H(this.$el, "hide", () => t.forEach(e => e && e()), {
          self: !0
        }), this.bgScroll || H(this.$el, "hidden", Dn(this.$el), {
          self: !0
        });
      }
    }, {
    ...
    methods: {
      show(t = this.targetEl, e = !0) {
        ...
        this.targetEl = t, this.clearTimers(), !this.isActive()) {
          ...
          this.container && P(this.$el) !== this.container && L(this.container, this.$el), 
      ...
      hide(t = !0, e = !0) {
        ...
        this.clearTimers(), this.isDelayedHide = t, this.isDelaying = jl(this.$el).some(s => this.tracker.movesTo(s)), 
      ...
      position() {
        O(this.$el, "uc-drop-stack"), c(this.$el, this._style), this.$el.hidden = !0;
        const t = this.target.map(n => Rl(this.$el, n)), e = this.getViewportOffset(this.$el), i = [ [ 0, [ "x", "width", "left", "right" ] ], [ 1, [ "y", "height", "top", "bottom" ] ] ];
        ...
        this.$el.hidden = !1, c(this.$el, "maxWidth", ""), this.$el.offsetWidth > s && $(this.$el, "uc-drop-stack"), 
        c(this.$el, "maxWidth", s), this.positionAt(this.$el, this.target, this.boundary);
  ...
  function Ul(t) {
    const e = () => t.$emit(), i = [ os(e), de(Ut(t.$el).concat(t.target), e) ];
    return () => i.map(s => s.disconnect());
  }
  function Mo(t, e = () => t.$emit()) {
    return b([ document, ...Ut(t.$el) ], "scroll", e, {
      passive: !0
    });
  }
  function Vl(t) {
  ...
  function Yl(t) {
    return Mo(t, () => t.hide(!1));
  }
  function Xl(t) {
    return b(document, ft, ({target: e}) => {
      t.$el.contains(e) || H(document, `${Ot} ${mi} scroll`, ({defaultPrevented: i, type: s, target: n}) => {
        !i && s === Ot && e === n && !(t.targetEl && Ws(e, t.targetEl)) && t.hide(!1);
      }, !0);
    });
  }
  var Bo = {
    ...
    computed: {
      ...
      dropbar({dropbar: t}) {
        return t ? (t = this._dropbar || J(t, this.$el) || k(`+ .${this.clsDropbar}`, this.$el), 
        t || (this._dropbar = k("<div></div>"))) : null;
      },
      dropContainer(t, e) {
    ...
    watch: {
      dropbar(t) {
        $(t, "uc-dropbar", "uc-dropbar-top", this.clsDropbar, `uc-${this.$options.name}-dropbar`);
      },
      dropdowns() {
    ...
    events: [ {
      ...
      handler(t) {
        ...
        s === _.DOWN && (n == null ? void 0 : n.targetEl) === i && (t.preventDefault(), 
        (e = k(Ee, n.$el)) == null || e.focus()), No(t, this.items, n);
      }
    }, {
      name: "keydown",
      el() {
      ...
      handler(t) {
        ...
        let o = -1;
        if (s === _.HOME ? o = 0 : s === _.END ? o = "last" : s === _.UP ? o = "previous" : s === _.DOWN ? o = "next" : s === _.ESC && ((e = n.targetEl) == null || e.focus()), 
        ~o) {
          t.preventDefault();
          const r = z(Ee, i);
          r[ot(o, r, bt(r, a => E(a, ":focus")))].focus();
        }
        No(t, this.items, n);
      }
    }, {
      ...
      handler() {
        ...
        t && m(t.mode, "hover") && !this.dropdowns.some(e => E(e, ":hover")) && t.hide();
      }
    }, {
      name: "beforeshow",
      el() {
      ...
      handler({target: t}) {
        this.isDropbarDrop(t) && (this.dropbar.previousElementSibling !== this.dropbarAnchor && ci(this.dropbarAnchor, this.dropbar), 
        $(t, `${this.clsDrop}-dropbar`));
      }
    }, {
      name: "show",
      el() {
      ...
      handler({target: t}) {
        ...
        this._observer = de([ e.$el, ...e.target ], i), i();
      }
    }, {
      name: "beforehide",
      el() {
      ...
      handler(t) {
        const e = this.getActive();
        E(this.dropbar, ":hover") && e.$el === t.target && this.isDropbarDrop(e.$el) && m(e.mode, "hover") && e.isDelayedHide && !this.items.some(i => e.targetEl !== i && E(i, ":focus")) && t.preventDefault();
      }
    }, {
      name: "hide",
      el() {
    ...
    methods: {
      ...
      async transitionTo(t, e) {
        ...
        if (e = s < t && e, await D.cancel([ e, i ]), e) {
          const n = I(e).top - I(i).top - s;
          n > 0 && c(e, "transitionDelay", `${n / t * this.duration}ms`);
        }
        c(e, "clipPath", `polygon(0 0,100% 0,100% ${s}px,0 ${s}px)`), st(i, s), await Promise.all([ D.start(i, {
          height: t
        }, this.duration), D.start(e, {
  ...
  function No(t, e, i) {
    ...
    let l = -1;
    a === _.HOME ? l = 0 : a === _.END ? l = "last" : a === _.LEFT ? l = "previous" : a === _.RIGHT ? l = "next" : a === _.TAB && ((s = i.targetEl) == null || s.focus(), 
  ...
  var Gl = {
    ...
    update() {
      ...
      if (!e) return;
      let s;
      const n = Ui(e) ? "value" : "textContent", o = e[n], r = (t = i.files) != null && t[0] ? i.files[0].name : E(i, "select") && (s = z("option", i).filter(a => a.selected)[0]) ? s.textContent : i.value;
      o !== r && (e[n] = r);
    },
    events: [ {
      name: "change",
    ...
    connected() {
      this.masonry && $(this.$el, "uc-flex-top", "uc-flex-wrap-top");
    },
    observe: We({
    ...
    update: [ {
      ...
      read(t) {
        ...
        if (s = Math.max(0, U(s)), !(i || s || n) || zo(e) || e[0].some((x, C) => e.some(M => M[C] && M[C].offsetWidth !== x.offsetWidth))) return t.translates = t.scrollColumns = !1;
        let r = Zl(e, o), a, l;
        i ? [a, l] = Kl(e, r, i === "next") : a = Ql(e);
        const h = a.map(x => zt(x, "offsetHeight") + r * (x.length - 1)), u = Math.max(0, ...h);
        let d, f, v;
        return (s || n) && (d = h.map((x, C) => n ? u - x + s : s / (C % 2 || 8)), n || (s = Math.max(...h.map((x, C) => x + d[C] - u))), 
        f = U(this.parallaxStart, "height", this.$el, !0), v = U(this.parallaxEnd, "height", this.$el, !0)), 
        {
          columns: a,
          translates: l,
          scrollColumns: d,
  ...
  function Kl(t, e, i) {
    ...
    for (let a of t) {
      ...
      for (const h in a) {
        ...
        _s(s, f, a[h]), _s(n, f, [ (f - h) * u * (V ? -1 : 1), o[f] - r ]), o[f] += d + e, 
        l = Math.max(l, d);
      }
      r += l + e;
    }
  ...
  var th = {
    ...
    update: {
      read() {
        return {
          rows: (this.row ? ms(this.elements) : [ this.elements ]).map(eh)
        };
      },
      write({rows: t}) {
  ...
  function ih(t) {
    ...
    const i = w(t).height - Me(t, "height", "content-box");
    return c(t, e), i;
  }
  var sh = {
    args: "target",
    ...
    update: {
      read() {
        ...
        let t = "";
        const e = Me(this.$el, "height", "content-box"), {body: i, scrollingElement: s} = document, n = Dt(this.$el), {height: o} = lt(n === i ? s : n), r = s === n || i === n;
        if (t = `calc(${r ? "100vh" : `${o}px`}`, this.expand) {
          ...
          this.offsetBottom === !0 ? t += ` - ${w(this.$el.nextElementSibling).height}px` : vt(this.offsetBottom) ? t += ` - ${this.offsetBottom}vh` : this.offsetBottom && ee(this.offsetBottom, "px") ? t += ` - ${S(this.offsetBottom)}px` : N(this.offsetBottom) && (t += ` - ${w(J(this.offsetBottom, this.$el)).height}px`);
        }
        return t += `${e ? ` - ${e}px` : ""})`, {
          minHeight: t
        };
    ...
    connected() {
      this.svg = this.getSvg().then(t => {
        ...
        return this.svgEl && e !== this.svgEl && at(this.svgEl), Ih.call(this, e, t), this.svgEl = e;
      }, A);
    },
    disconnected() {
      this.svg.then(t => {
  ...
  function Sh(t, e) {
    if (qi(e) || R(e, "canvas")) {
      ...
      return Lo(t, s) ? s : ci(e, t);
    }
    const i = e.lastElementChild;
    return Lo(t, i) ? i : L(e, t);
  }
  function Lo(t, e) {
  ...
  const Oi = {
    ...
    "drop-parent-icon": ah,
    "nav-parent-icon": ch,
    "nav-parent-icon-large": hh,
    "navbar-parent-icon": uh,
    "navbar-toggle-icon": dh,
    "overlay-icon": fh,
    "pagination-next": ph,
    "pagination-previous": gh,
    "search-icon": Fo,
    "search-large": mh,
    "search-navbar": vh,
    "search-toggle-icon": Fo,
    "slidenav-next": bh,
    "slidenav-next-large": wh,
    "slidenav-previous": $h,
    "slidenav-previous-large": xh
  }, As = {
    install: Bh,
    mixins: [ Ho ],
    args: "icon",
    ...
    beforeConnect() {
      const t = y(this.$el, "uc-search-toggle") || y(this.$el, "uc-navbar-toggle");
      if (this.icon = t ? "search-toggle-icon" : y(this.$el, "uc-search-icon") && ri(this.$el, ".uc-search-large") ? "search-large" : ri(this.$el, ".uc-search-navbar") ? "search-navbar" : this.$props.icon, 
      !Tt(this.$el, "aria-label")) if (t) {
    ...
    beforeConnect() {
      ...
      e && !Tt(t, "aria-label") && p(t, "aria-label", e);
    }
  }, Wo = {
    extends: Zt,
    beforeConnect() {
      $(this.$el, "uc-slidenav");
      const t = this.$props.icon;
      this.icon = y(this.$el, "uc-slidenav-large") ? `${t}-large` : t;
    }
  }, Ph = {
    extends: Zt,
    i18n: {
    ...
    beforeConnect() {
      this.icon = `close-${y(this.$el, "uc-close-large") ? "large" : "icon"}`;
    }
  }, Ah = {
    extends: Zt,
    i18n: {
  ...
  function zh(t) {
    return t = Nh[t] || t, Oi[t] ? (Di[t] || (Di[t] = k((Oi[Fh(t)] || Oi[t]).trim())), 
    Di[t].cloneNode(!0)) : null;
  }
  function Fh(t) {
  ...
  var Hh = {
    ...
    connected() {
      this.loading !== "lazy" ? this.load() : Ds(this.$el) && (this.$el.loading = "lazy", 
      Os(this.$el));
    },
    disconnected() {
    ...
    observe: He({
      target: ({$el: t, $props: e}) => [ t, ...Ae(e.target, t) ],
      handler(t, e) {
    ...
    methods: {
      load() {
        ...
        const t = Ds(this.$el) ? this.$el : Wh(this.$el, this.dataSrc, this.sources);
        return Ce(t, "loading"), Os(this.$el, t.currentSrc), this.img = t;
      }
    }
  };
  function Os(t, e) {
    if (Ds(t)) {
      const i = P(t);
      (R(i, "picture") ? B(i) : [ t ]).forEach(n => jo(n, n));
    } else e && !m(t.style.backgroundImage, e) && (c(t, "backgroundImage", `url(${Xi(e)})`), 
    g(t, Ht("load", !1)));
  }
  const Lh = [ "data-src", "data-srcset", "sizes" ];
  function jo(t, e) {
    for (const i of Lh) {
      const s = G(t, i);
  ...
  function Rh(t) {
    ...
    return Q(t) || (t = [ t ]), t.filter(e => !ei(e));
  }
  function Ds(t) {
    return R(t, "img");
  }
  var qh = {
    ...
    observe: [ ps({
      ...
      target: ({target: t}) => t,
      observe: (t, e) => {
        const i = de([ ...t, document.documentElement ], e), s = [ b(document, "scroll itemshown itemhidden", e, {
          passive: !0,
          capture: !0
        }), b(document, "show hide transitionstart", n => (e(), i.observe(n.target))), b(document, "shown hidden transitionend transitioncancel", n => (e(), 
    ...
    update: {
      read() {
        for (const t of this.target) ni(t, "uc-light,uc-dark", !this.selActive || E(t, this.selActive) ? Uh(t) : "");
      }
    }
  };
  function Uh(t) {
    ...
    for (const r of [ .25, .5, .75 ]) {
      ...
      for (const l of a) {
        if (t.contains(l) || l.closest('[class*="-leave"]') && a.some(u => l !== u && E(u, '[class*="-enter"]'))) continue;
        const h = c(l, "--uc-inverse");
        if (h) {
          if (h === o) return `uc-${h}`;
          o = h;
          break;
  ...
  var Vh = {
    ...
    computed: {
      fill: ({fill: t}, e) => t || c(e, "--uc-leader-fill-content")
    },
    connected() {
    ...
    events: [ {
      ...
      self: !0,
      handler() {
        y(this.panel, "uc-margin-auto-vertical") ? $(this.$el, "uc-flex") : c(this.$el, "display", "block"), 
        st(this.$el);
      }
    }, {
      name: "hidden",
      self: !0,
      handler() {
        c(this.$el, "display", ""), O(this.$el, "uc-flex");
      }
    } ]
  };
  function Xh({modal: t}) {
    t.dialog = function(i, s) {
      const n = t(`<div class="uc-modal"> <div class="uc-modal-dialog">${i}</div> </div>`, {
        stack: !0,
        role: "alertdialog",
        ...s
      });
      ...
      return e(({i18n: n}) => `<div class="uc-modal-body">${N(i) ? i : Lt(i)}</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-primary uc-modal-close" autofocus>${n.ok}</button> </div>`, s);
    }, t.confirm = function(i, s) {
      return e(({i18n: n}) => `<form> <div class="uc-modal-body">${N(i) ? i : Lt(i)}</div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-default uc-modal-close" type="button">${n.cancel}</button> <button class="uc-button uc-button-primary" autofocus>${n.ok}</button> </div> </form>`, s, () => Promise.reject());
    }, t.prompt = function(i, s, n) {
      const o = e(({i18n: l}) => `<form class="uc-form-stacked"> <div class="uc-modal-body"> <label>${N(i) ? i : Lt(i)}</label> <input class="uc-input" value="${s || ""}" autofocus> </div> <div class="uc-modal-footer uc-text-right"> <button class="uc-button uc-button-default uc-modal-close" type="button">${l.cancel}</button> <button class="uc-button uc-button-primary">${l.ok}</button> </div> </form>`, n, () => null, () => a.value), {$el: r} = o.dialog, a = k("input", r);
  ...
  const Ms = "uc-navbar-transparent";
  var Jh = {
    extends: Bo,
    props: {
    ...
    watch: {
      items() {
        const t = y(this.$el, "uc-navbar-justify"), e = z(".uc-navbar-nav, .uc-navbar-left, .uc-navbar-right", this.$el);
        for (const i of e) {
          const s = t ? z(".uc-navbar-nav > li > a, .uc-navbar-item, .uc-navbar-toggle", i).length : "";
          c(i, "flexGrow", s);
        }
      }
    },
    events: [ {
      ...
      handler({target: t}) {
        this.getTransparentMode(t) === "remove" && y(this.navbarContainer, Ms) && (O(this.navbarContainer, Ms), 
        this._transparent = !0);
      }
    }, {
      name: "hide",
      ...
      async handler() {
        await Kh(), !this.getActive() && this._transparent && ($(this.navbarContainer, Ms), 
    ...
    methods: {
      getTransparentMode(t) {
        ...
        if (e && y(t, "uc-dropbar")) return e.inset ? "behind" : "remove";
      },
      getDropbarOffset(t) {
  ...
  var Zh = {
    ...
    events: [ {
      ...
      self: !0,
      handler() {
        this.mode === "reveal" && !y(P(this.panel), this.clsMode) && (di(this.panel, "<div>"), 
        $(P(this.panel), this.clsMode));
        const {body: t, scrollingElement: e} = document;
        $(t, this.clsContainer, this.clsFlip), c(t, "touch-action", "pan-y pinch-zoom"), 
        c(this.$el, "display", "block"), c(this.panel, "maxWidth", e.clientWidth), $(this.$el, this.clsOverlay), 
        $(this.panel, this.clsSidebarAnimation, this.mode === "reveal" ? "" : this.clsMode), 
        st(t), $(t, this.clsContainerAnimation), this.clsContainerAnimation && Qh();
      }
    }, {
      name: "hide",
      self: !0,
      ...
      self: !0,
      handler() {
        this.clsContainerAnimation && tc(), this.mode === "reveal" && re(this.panel), O(this.panel, this.clsSidebarAnimation, this.clsMode), 
        O(this.$el, this.clsOverlay), c(this.$el, "display", ""), c(this.panel, "maxWidth", ""), 
  ...
  var ec = {
    ...
    update: {
      read() {
        return !this.content || !this.container || !q(this.$el) ? !1 : {
          max: Math.max(this.minHeight, st(this.container) - (w(this.content).height - st(this.$el)))
        };
      },
      write({max: t}) {
        c(this.$el, {
    ...
    props: [ "width", "height" ],
    connected() {
      $(this.$el, "uc-responsive-width"), c(this.$el, "aspectRatio", `${this.width}/${this.height}`);
    }
  }, sc = {
    props: {
      offset: Number
    ...
    methods: {
      async scrollTo(t) {
        t = t && k(t) || document.body, g(this.$el, "beforescroll", [ this, t ]) && (await un(t, {
          offset: this.offset
  ...
  const Ze = new Set;
  function nc(t) {
    Ze.size || b(document, "click", qo), Ze.add(t);
  }
  function oc(t) {
    Ze.delete(t), Ze.size || Pt(document, "click", qo);
  }
  function qo(t) {
    if (!t.defaultPrevented) for (const e of Ze) e.$el.contains(t.target) && oe(e.$el) && (t.preventDefault(), 
  ...
  var rc = {
    ...
    observe: He({
      ...
      handler(t) {
        ...
        for (const {target: i, isIntersecting: s} of t) {
          e.has(i) || e.set(i, {
            cls: G(i, "uc-scrollspy-class") || this.cls
          });
          const n = e.get(i);
    ...
    methods: {
      toggle(t, e) {
        ...
        if (s) {
          if ((i = s.off) == null || i.call(s), c(t, "opacity", !e && this.hidden ? 0 : ""), 
          j(t, this.inViewClass, e), j(t, s.cls), /\buc-animation-/.test(s.cls)) {
            const n = () => Ri(t, "uc-animation-[\\w-]+");
    ...
    update: [ {
      read() {
        ...
        const i = Dt(t, !0), {scrollTop: s, scrollHeight: n} = i, o = lt(i), r = n - o.height;
        let a = !1;
        if (s === r) a = e - 1; else {
      ...
      write({active: t}) {
        ...
        e && g(this.$el, "active", [ t, this.elements[t] ]);
      },
      events: [ "scroll", "resize" ]
    } ]
  }, lc = {
    ...
    connected() {
      this.start = Uo(this.start || this.top), this.end = Uo(this.end || this.bottom), 
      this.placeholder = k("+ .uc-sticky-placeholder", this.$el) || k('<div class="uc-sticky-placeholder"></div>'), 
      this.isFixed = !1, this.setActive(!1);
    },
    beforeDisconnect() {
      this.isFixed && (this.hide(), O(this.target, this.clsInactive)), Vo(this.$el), at(this.placeholder), 
    ...
    update: [ {
      read({height: t, width: e, margin: i, sticky: s}) {
        ...
        n && (Ns(this.target), this.hide()), this.active || (({height: t, width: e} = I(this.$el)), 
        i = c(this.$el, "margin")), n && this.show();
        const o = U("100vh", "height"), r = st(window), a = Math.max(0, document.scrollingElement.scrollHeight - o);
        let l = this.position;
      ...
      write({height: t, width: e, margin: i, offset: s, sticky: n}) {
        if ((this.inactive || n || !this.isFixed) && Vo(this.$el), this.inactive) return;
        n && (t = e = i = 0, c(this.$el, {
          position: "sticky",
          top: s
        }));
        ...
        c(o, {
          ...
          width: e,
          margin: i
        }), (P(o) !== P(this.$el) || n ^ Et(o) < Et(this.$el)) && ((n ? hi : ci)(this.$el, o), 
        o.hidden = !0);
      },
      events: [ "resize" ]
    }, {
      ...
      write(t, e) {
        ...
        const d = Date.now();
        if ((d - s > 300 || n !== o) && (t.initScroll = r, t.initTimestamp = d), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10)) if (this.inactive || r < h || this.showOnUp && (r <= h || n === "down" && i || n === "up" && !this.isFixed && !u)) {
          if (!this.isFixed) {
            At.inProgress(this.$el) && l > r && (At.cancel(this.$el), this.hide());
            return;
          }
          if (this.animation && u) {
            if (y(this.$el, "uc-animation-leave")) return;
            At.out(this.$el, this.animation).then(() => this.hide(), A);
          } else this.hide();
        } else this.isFixed ? this.update() : this.animation && u ? (this.show(), At.in(this.$el, this.animation).catch(A)) : (Ns(this.target), 
        this.show());
      },
    ...
    methods: {
      ...
      hide() {
        ...
        this.setActive(!1), O(this.$el, this.clsFixed, this.clsBelow), e ? c(this.$el, "top", t) : c(this.$el, {
          position: "",
          top: "",
          width: "",
          marginTop: ""
      ...
      setActive(t) {
        const e = this.active;
        this.active = t, t ? (ni(this.target, this.clsInactive, this.clsActive), e !== t && g(this.$el, "active")) : (ni(this.target, this.clsActive, this.clsInactive), 
        e !== t && (Ns(this.target), g(this.$el, "inactive")));
      }
    }
  };
  function Bs(t, e, i, s) {
  ...
  function Ns(t) {
    $(t, "uc-transition-disable"), requestAnimationFrame(() => O(t, "uc-transition-disable"));
  }
  var hc = {
    mixins: [ Ho ],
    args: "src",
    ...
    async connected() {
      ...
      const t = await this.svg;
      t && (Yo.call(this, t), this.strokeAnimation && fc(t));
    },
    methods: {
      async getSvg() {
        return R(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy" && await new Promise(t => H(this.$el, "load", t)), 
        uc(await cc(this.src), this.icon) || Promise.reject("SVG not found.");
      }
    }
  };
  function Yo(t) {
  ...
  const cc = rt(async t => t ? dt(t, "data:") ? decodeURIComponent(t.split(",")[1]) : (await fetch(t)).text() : Promise.reject());
  function uc(t, e) {
    return e && m(t, "<symbol") && (t = dc(t)[e] || t), t = k(t.substr(t.indexOf("<svg"))), 
    (t == null ? void 0 : t.hasChildNodes()) && t;
  }
  const Xo = /<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g, dc = rt(function(t) {
    const e = {};
    Xo.lastIndex = 0;
    let i;
    for (;i = Xo.exec(t); ) e[i[3]] = `<svg ${i[1]}svg>`;
    return e;
  });
  function fc(t) {
    const e = so(t);
    e && c(t, "--uc-animation-stroke", e);
  }
  const zs = ".uc-disabled *, .uc-disabled, [disabled]";
  var Go = {
    mixins: [ Vt ],
    args: "connect",
    props: {
    ...
    events: [ {
      ...
      handler(t) {
        !E(t.current, zs) && (t.type === "click" || t.keyCode === _.SPACE) && (t.preventDefault(), 
        this.show(t.current));
      }
    }, {
      name: "keydown",
      ...
      handler(t) {
        ...
        if (~n) {
          t.preventDefault();
          const o = this.toggles.filter(a => !E(a, zs)), r = o[ot(n, o, o.indexOf(e))];
      ...
      handler(t) {
        t.target.closest("a,button") && (t.preventDefault(), this.show(G(t.current, this.attrItem)));
      }
    }, {
    ...
    update() {
      ...
      for (const e in this.toggles) {
        ...
        p(i, "role", "tab"), s && (i.id = Gt(this, i), s.id = Gt(this, s), p(i, "aria-controls", s.id), 
        p(s, {
          role: "tabpanel",
          "aria-labelledby": i.id
        }));
      }
      p(this.$el, "aria-orientation", E(this.$el, this.selVertical) ? "vertical" : null);
    },
    methods: {
      index() {
      ...
      show(t) {
        const e = this.toggles.filter(r => !E(r, zs)), i = this.index(), s = ot(!ti(t) || m(e, t) ? t : 0, e, ot(this.toggles[i], e)), n = ot(e[s], this.toggles);
    ...
    connected() {
      const t = y(this.$el, "uc-tab-left") ? "uc-tab-left" : y(this.$el, "uc-tab-right") ? "uc-tab-right" : !1;
  ...
  var mc = {
    ...
    connected() {
      m(this.mode, "media") || (oi(this.$el) || p(this.$el, "tabindex", "0"), !this.cls && R(this.$el, "a") && p(this.$el, "role", "button"));
    },
    observe: Le({
      target: ({target: t}) => t
    }),
    events: [ {
      ...
      handler(t) {
        this._preventClick = null, !(!yt(t) || se(this._showState) || this.$el.disabled) && (g(this.$el, "focus"), 
        H(document, ft, () => g(this.$el, "blur"), !0, e => !this.$el.contains(e.target)), 
        m(this.mode, "click") && (this._preventClick = !0));
      }
    }, {
      name: `mouseenter mouseleave ${ue} ${Ne} focus blur`,
      filter() {
        return m(this.mode, "hover");
      },
      handler(t) {
        if (yt(t) || this.$el.disabled) return;
        const e = m([ "mouseenter", ue, "focus" ], t.type), i = this.isToggled(this.target);
        if (!e && (!se(this._showState) || t.type !== "blur" && E(this.$el, ":focus") || t.type === "blur" && E(this.$el, ":hover"))) {
          i === this._showState && (this._showState = null);
          return;
        }
        e && se(this._showState) && i !== this._showState || (this._showState = e ? i : null, 
      ...
      handler(t) {
        let e;
        (this._preventClick || t.target.closest('a[href="#"], a[href=""]') || (e = t.target.closest("a[href]")) && (!this.isToggled(this.target) || e.hash && E(this.target, e.hash))) && t.preventDefault(), 
    ...
    methods: {
      async toggle(t) {
        ...
        if (Tt(this.$el, "aria-expanded") && p(this.$el, "aria-expanded", !this.isToggled(this.target)), 
  ...
  return Nt(vc, (t, e) => ut.component(e, t)), Dl(ut), Nt(Ol, (t, e) => ut.component(e, t)), 
  ut;
});