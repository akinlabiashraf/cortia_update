...
(function() {
  function L(a) {
    ...
    function h(a) {
      ...
      o && b.push("^");
      b.push.apply(b, a);
      for (c = 0; c < f.length; ++c) i = f[c], b.push(e(i[0])), i[1] > i[0] && (i[1] + 1 > i[0] && b.push("-"), 
      b.push(e(i[1])));
      b.push("]");
      return b.join("");
    }
    ...
    function m(a) {
      switch (a.nodeType) {
       ...
       case 4:
        ...
        h[s] = g, t[s << 1] = y, y += g.length, t[s++ << 1 | 1] = a);
      }
    }
    ...
    function e(a) {
      for (var l = a.d, p = [ l, "pln" ], d = 0, g = a.a.match(y) || [], r = {}, n = 0, z = g.length; n < z; ++n) {
        ...
        if (typeof b === "string") c = !1; else {
          ...
          if ((c = b.length >= 5 && "lang-" === b.substring(0, 5)) && !(o && typeof o[1] === "string")) c = !1, 
          b = "src";
          c || (r[f] = b);
        }
        i = d;
  ...
  function D(a, m) {
    ...
    for (var n = Math.max(0, m - 1 | 0) || 0, g = 0, z = d.length; g < z; ++g) l = d[g], 
    l.className = "L" + (g + n) % 10, l.firstChild || l.appendChild(s.createTextNode(" ")), 
    r.appendChild(l);
    a.appendChild(r);
  }
  function k(a, m) {
