                ...
                <div class="panel section-inner d-flex flex-column items-center justify-center gap-4" data-anime="translateY: [80, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 450; delay: 650;">
                    <div class="panel" data-anime="translateY: [80, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 450; delay: 650;">
                        <div class="panel vstack justify-center gap-3 text-center max-w-950px">
                            ...
                            <div class="panel">
                                <h1 class="display-4 md:display-2 xl:display-1 text-inherit xl:w-800px">CoreSure: Opaque Insurance Made Simple</h1>
                        ...
                        <div class="panel mt-4 vstack items-center" data-anime="translateY: [80, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 450; delay: 950;">
                            <img class="w-700px ms-5 rounded-3 shadow-lg" src="{{ asset('assets/images/solutions/coresure-success.png') }}" alt="CoreSure Solution Preview">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row child-cols-12 sm:child-cols-6 g-3 lg:g-4" data-anime="targets: > *; onview: -150; translateY: [16, 0]; opacity: [0, 1]; easing: easeOutExpo; duration: 750; delay: anime.stagger(100, {start: 500});">
                            ...
                            <div>
                                <div class="feature-item panel h-100 p-4 lg:p-5 vstack gap-4 rounded-3 bg-primary text-white shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden relative group">
                                    ...
                                    <div class="w-64px h-64px cstack bg-white rounded-circle shadow-sm text-primary mb-2 z-1">
                                        <img class="w-32px filter-primary" style="filter: brightness(0) saturate(100%) invert(20%) sepia(85%) saturate(3015%) hue-rotate(258deg) brightness(84%) contrast(98%);" src="{{ asset('assets/images/icons/deposit-alt.svg') }}" alt="icon">
                                    </div>
                                    <div class="vstack items-start gap-2 z-1">
                                        <h4 class="title h3 m-0 text-white fw-bold">Parametric Payouts</h4>
                                        <p class="desc fs-5 text-white opacity-85">Smart contracts auto-trigger settlements instantly when pre-defined data conditions are met.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="feature-item panel h-100 p-4 lg:p-5 vstack gap-4 rounded-3 bg-white text-dark shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                                    <div class="w-64px h-64px cstack bg-primary-100 rounded-circle text-primary mb-2">
                                        <img class="w-32px purple-icon" src="{{ asset('assets/images/icons/safe-box.svg') }}" alt="icon">
                                    </div>
                                    <div class="vstack items-start gap-2">
                                        <h4 class="title h3 m-0 fw-bold">Immutable claims Engine</h4>
                                        <p class="desc fs-5 text-secondary">A clear digital paper trail guarantees that valid claims are processed directly.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="feature-item panel h-100 p-4 lg:p-5 vstack gap-4 rounded-3 bg-white text-dark shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                                    ...
                                    <div class="vstack items-start gap-2">
                                        <h4 class="title h3 m-0 fw-bold">Grassroots Asset Shield</h4>
                                        <p class="desc fs-5 text-secondary">Secure health, local shops, and yields against sudden economic shocks.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="feature-item panel h-100 p-4 lg:p-5 vstack gap-4 rounded-3 bg-white text-dark shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                                    ...
                                    <div class="vstack items-start gap-2">
                                        <h4 class="title h3 m-0 fw-bold">Economic Resilience</h4>
                                        <p class="desc fs-5 text-secondary">Layering financial resilience right down to underserved grassroots earners.</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="panel">
                                            <ul class="list nav-y gap-3 text-start">
                                                <li class="hstack items-start gap-3 p-3 bg-light rounded-3 border border-gray-100 transition-all hover:-translate-y-1 hover:shadow-sm">
                                                    ...
                                                    <span class="fs-5 sm:fs-5 fw-medium text-dark mt-1">Endless bureaucracy and complex manual claiming procedures.</span>
                                                </li>
                                                <li class="hstack items-start gap-3 p-3 bg-light rounded-3 border border-gray-100 transition-all hover:-translate-y-1 hover:shadow-sm">
                                                    <div class="w-32px h-32px cstack bg-white rounded-circle shadow-xs text-danger flex-none">
                                                        <i class="icon icon-1 unicon-close"></i>
                                                    </div>
                                                    <span class="fs-5 sm:fs-5 fw-medium text-dark mt-1">Exorbitant upfront fees and rigid annual premium demands.</span>
                                                </li>
                                                <li class="hstack items-start gap-3 p-3 bg-light rounded-3 border border-gray-100 transition-all hover:-translate-y-1 hover:shadow-sm">
                                                    <div class="w-32px h-32px cstack bg-white rounded-circle shadow-xs text-danger flex-none">
                                                        <i class="icon icon-1 unicon-close"></i>
                                                    </div>
                                                    <span class="fs-5 sm:fs-5 fw-medium text-dark mt-1">Opaque payout terms and frequent claims rejections.</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="panel mt-2">
                                            <a class="btn btn-md bg-danger text-white border-0 text-none w-fit shadow-md hover:-translate-y-1 transition-all" href="{{ url('/contact') }}">Report a Claim Issue
                                    ...
                                    <div class="panel vstack gap-4">
                                        <div class="panel vstack gap-3">
                                            <div class="px-3 py-1 bg-primary text-white w-fit rounded-pill hstack items-center shadow-xs">
                                                ...
                                                <p class="fs-7 fw-bold m-0 text-uppercase tracking-wider">Radical Consistent Affordability</p>
                                            </div>
                                            <h1 class="display-4 sm:display-3 m-0 text-black fw-bold">Radical economic protection built for grassroots realities</h1>
                                            <p class="fs-5 text-gray-600 dark:text-white leading-relaxed">CoreSure fundamentally re-engineers risk protection for the underserved. By stripping away large lump-sum demands, our platform introduces frictionless micro-payments that blend smoothly into anyone's daily cash flow without strain.</p>
                                        </div>
                                        <div class="panel vstack gap-3">
                                            <ul class="uc-accordion-divider uc-accordion-chevron gap-3" data-uc-accordion="collapsible: false" style="--divider-gap: 0px">
                                                <li class="bg-light p-3 xl:p-4 rounded-3 border border-gray-100 mb-2">
                                                    ...
                                                    <div class="uc-accordion-content mt-3 ms-5 ps-2">
                                                        <p class="fs-5 text-secondary m-0">Pay tiny amounts weekly or monthly that match your real-world income patterns.</p>
                                                    </div>
                                                </li>
                                                <li class="bg-light p-3 xl:p-4 rounded-3 border border-gray-100 mb-2">
                                                    <a class="uc-accordion-title h5 lg:h4 m-0 text-black fw-bold text-none">
                                                    ...
                                                    <div class="uc-accordion-content mt-3 ms-5 ps-2">
                                                        <p class="fs-5 text-secondary m-0">A clear digital paper trail guarantees that valid claims are processed directly without traditional delays.</p>
                                                    </div>
                                                </li>
                                                <li class="bg-light p-3 xl:p-4 rounded-3 border border-gray-100 mb-2">
                                                    <a class="uc-accordion-title h5 lg:h4 m-0 text-black fw-bold text-none">
                                                    ...
                                                    <div class="uc-accordion-content mt-3 ms-5 ps-2">
                                                        <p class="fs-5 text-secondary m-0">By giving everyday citizens an uncomplicated platform to safe-keep their assets, Cortia is layering economic resilience right down to the grassroots level.</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <aside class="panel vstack gap-4 bg-white p-5 rounded-4 shadow-md border border-gray-100 h-100">
                                        <div class="vstack gap-3">
                                            ...
                                            <div class="hstack justify-between fs-5 my-2">
                                                ...
                                                <span class="fw-bold text-dark">CoreSure</span>
                                            </div>
                                            <div class="hstack justify-between fs-5 my-2">
                                                <span class="text-secondary">Sector Focus:</span>
                                                <span class="fw-bold text-dark">InsurTech / Micro-insurance</span>
                                            </div>
                                            <div class="hstack justify-between fs-5 my-2">
                                                <span class="text-secondary">Core Function:</span>
                                                <span class="fw-bold text-dark">Risk Protection & Micro-Payments</span>
                                            </div>
                                        </div>
                                    </aside>
                                </div>
                ...
                <div class="section-content panel mt-6 sm:mt-8 xl:mt-9" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 100});">
                    ...
                    <div class="panel mb-6 d-flex justify-center">
                        <ul class="main-use-cases-nav hstack gap-2 justify-center text-center p-2 rounded-pill shadow-xs backdrop-filter-blur" style="background-color: rgba(255,255,255,0.1);" data-uc-switcher="connect: .main-use-cases-switcher; animation: uc-animation-fade;">
                            <li><a class="btn btn-md text-none text-white rounded-pill px-4 fw-medium" href="#">Micro-Entrepreneurs</a></li>
                            <li><a class="btn btn-md text-none text-white rounded-pill px-4 fw-medium" href="#">Low-Wage Households</a></li>
                            <li><a class="btn btn-md text-none text-white rounded-pill px-4 fw-medium" href="#">Institutional Partners</a></li>
                        </ul>
                    </div>
                                ...
                                <div class="sm:col-7 lg:col-7 order-2 lg:order-1">
                                    <div class="panel vstack justify-center gap-4 text-white">
                                        <div class="px-3 py-1 bg-white text-primary w-fit rounded-pill hstack items-center shadow-xs">
                                            <p class="fs-7 fw-bold m-0 text-uppercase tracking-wider">Shop Owners</p>
                                        </div>
                                        <h3 class="display-5 m-0 text-white fw-bold">Insure Your Source of Livelihood Stress-Free</h3>
                                        <p class="fs-4 text-white-50 leading-relaxed">Bite-sized commercial protection shields kiosks and retail shops from unexpected losses due to fire, theft, or natural disasters, ensuring business continuity.</p>
                                        <div class="panel border-top border-white-10 pt-4 mt-2">
                                            <h6 class="h4 m-0 text-white fw-bold">Grassroots Retail Shield</h6>
                                            <span class="fs-5 opacity-75">Mitigating risk factors to secure small businesses globally.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="sm:col-5 lg:col-5 order-1 lg:order-2">
                                    <div class="panel h-100 overflow-hidden rounded-3 shadow-lg">
                                        <img class="w-100 h-100 object-cover hover:scale-105 transition-all duration-500" src="{{ asset('assets/images/solutions/coresure_shop_owner_1779919782657.png') }}" alt="Merchant kiosk insurance">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel">
                            <div class="row g-4 xl:g-8 col-match items-center rounded-4 border border-white-10 p-4 lg:p-6 shadow-xl backdrop-filter-blur" style="background-color: rgba(255,255,255,0.05);">
                                <div class="sm:col-7 lg:col-7 order-2 lg:order-1">
                                    <div class="panel vstack justify-center gap-4 text-white">
                                        <div class="px-3 py-1 bg-white text-primary w-fit rounded-pill hstack items-center shadow-xs">
                                            <p class="fs-7 fw-bold m-0 text-uppercase tracking-wider">Low-Wage Families</p>
                                        </div>
                                        <h3 class="display-5 m-0 text-white fw-bold">Protecting Family Health and Core Assets</h3>
                                        <p class="fs-4 text-white-50 leading-relaxed">Flexible family premiums guarantee that healthcare emergencies or life transitions don't result in immediate financial catastrophe for low-wage households.</p>
                                        <div class="panel border-top border-white-10 pt-4 mt-2">
                                            <h6 class="h4 m-0 text-white fw-bold">Family Resilience Plan</h6>
                                            <span class="fs-5 opacity-75">Ensuring a digital financial shield that fits your daily living.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="sm:col-5 lg:col-5 order-1 lg:order-2">
                                    <div class="panel h-100 overflow-hidden rounded-3 shadow-lg">
                                        <img class="w-100 h-100 object-cover hover:scale-105 transition-all duration-500" src="{{ asset('assets/images/solutions/coresure-success.png') }}" alt="Family financial protection plan">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel">
                            <div class="row g-4 xl:g-8 col-match items-center rounded-4 border border-white-10 p-4 lg:p-6 shadow-xl backdrop-filter-blur" style="background-color: rgba(255,255,255,0.05);">
                                <div class="sm:col-7 lg:col-7 order-2 lg:order-1">
                                    <div class="panel vstack justify-center gap-4 text-white">
                                        <div class="px-3 py-1 bg-white text-primary w-fit rounded-pill hstack items-center shadow-xs">
                                            <p class="fs-7 fw-bold m-0 text-uppercase tracking-wider">Institutional Partners</p>
                                        </div>
                                        <h3 class="display-5 m-0 text-white fw-bold">Reach Underserved Markets Safely</h3>
                                        <p class="fs-4 text-white-50 leading-relaxed">Insurtech partnerships enable large underwriters to scale risk portfolios securely down to the grassroots, backed by transparent smart-ledger ledger.</p>
                                        <div class="panel border-top border-white-10 pt-4 mt-2">
                                            <h6 class="h4 m-0 text-white fw-bold">Automated Risk Distribution</h6>
                                            <span class="fs-5 opacity-75">Integrate direct micro-settlement ledgers into your core workflows.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="sm:col-5 lg:col-5 order-1 lg:order-2">
                                    <div class="panel h-100 overflow-hidden rounded-3 shadow-lg">
                                        <img class="w-100 h-100 object-cover hover:scale-105 transition-all duration-500" src="{{ asset('assets/images/solutions/coresure-success.png') }}" alt="Institutional risk distribution system">
                                    </div>
                                </div>
                            </div>
                        </div>
